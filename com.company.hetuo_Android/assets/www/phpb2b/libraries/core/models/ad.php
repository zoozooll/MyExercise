   ...
   type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer" />
 	...
 	function getFocus($params)
 	{
 		...
 		switch ($target) {
 			case "fair":
 				$table = "expoes";
 				$fields = "id,name AS title,picture,picture";
 				$url = "fair/detail.php?id=";
 				break;
 			default:
 				$table = "newses";
 				$fields = "id,title,picture,picture";
 				$url = "news/detail.php?id=";
 				break;
 		}
 		$sql = "SELECT ".$fields." FROM ".$this->table_prefix.$table." WHERE status='1' AND picture!='' ORDER BY id desc";
