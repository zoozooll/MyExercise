...
<div class="container">
    ...
    <div class="apart">
		...
		<div class="bigpart">
			<div class="title_uc"><h3><?php echo  $m_langpackage->m_iwant_pay;?></h3></div>
			<form action="do.php?act=user_order" method="post" name="form_profile">
				<table width="98%" class="form_table">
					...
					<tr><td class="textright"><?php echo  $m_langpackage->m_order_amount;?>：</td><td class="textleft">￥<?php echo  $order_info['order_amount'];?><?php echo  $m_langpackage->m_yuan;?></td></tr>
					...
					<a href="plugins/<?php echo $payment_info[$value['pay_id']]['pay_code'];?>/index.php?id=<?php echo  $order_info['order_id'];?>&pay_id=<?php echo $value['pay_id'];?>"><?php echo $payment_info[$value['pay_id']]['pay_name'];?>
					<img src="plugins/<?php echo $payment_info[$value['pay_id']]['pay_code'];?>/logo.gif" height="30" /></a> <br /><br />
						<?php }?>
					<?php }?>
					</td></tr>
				</table>
