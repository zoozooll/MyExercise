...
.clear {clear:both;}
td{text-align:left;}
#bgdiv { background-color:#333; position:absolute; width:960px; left:0px; top:0px; opacity:0.4; filter:alpha(opacity=40); height:1000px; z-index:960}
...
<div class="container">
    ...
    <div class="apart">
		...
		<div class="bigpart">
		<div class="title_uc"><h3><span style="float:right; margin-right:15px;"><a href="modules.php?app=goods_list" style="color:#F67A06;"><?php echo  $m_langpackage->m_back_list;?></a>&nbsp;&nbsp;</span><?php echo  $m_langpackage->m_add_goods;?></h3></div>
		<form action="do.php?act=goods_add" method="post" name="form_goods_add" onsubmit="return checkForm();" enctype="multipart/form-data">
			<table width="98%" class="form_table">
				...
				<tr><td class="textright"><?php echo  $m_langpackage->m_goods_price;?>：</td>
					<td><input type="type" name="goods_price" value="<?php echo  $goods_info['goods_price'];?>" style="width:80px;
						text-align:right;" maxlength="8" /> <?php echo  $m_langpackage->m_yuan;?> (<?php echo  $m_langpackage->m_goods_pricezero;?>)</td></tr>
				<tr>
					<td class="textright">
						<input type="radio" value="1" id="is_transport_template" onclick="chostransporttype(1)"  name="is_transport_template" /> <?php echo $m_langpackage->m_is_transport_template;?></td>
					<td>
					<?php if(is_array($transport_template_list)){?>
						<?php foreach($transport_template_list as $value){?>
							<input type="radio" name="transport_template_id" onclick="chostransporttype(1)"  value="<?php echo $value['id'];?>"  /><?php echo $value['transport_name'];?>&nbsp;<a href="modules.php?app=edit_transport_template&id=<?php echo $value['id'];?>" target="_blank"><?php echo  $m_langpackage->m_eidt_transport_template;?></a>
						<?php }?>
					<?php }?>
					<br />
				...
				<tr>
					<td class="textright"><input type="radio"  onclick="chostransporttype(0)" value="0"  checked    name="is_transport_template" /><?php echo   $m_langpackage->m_transport_price;?>：</td>
					<td><input type="type" name="transport_price" value="<?php echo   $goods_info['transport_price'];?>" style="width:80px; text-align:right;" maxlength="8" /> <?php echo $m_langpackage->m_yuan;?></td>
				</tr>
				<tr><td class="textright"><span id="picspan"><?php echo  $m_langpackage->m_showgoods_photo;?></span></td>
					<td><input type="file" name="attach[]" onchange="showimg(this)" />
				...
				<tr><td class="textright"><?php echo  $m_langpackage->m_goods_intro;?>：</td>
					<td>
				...
				<tr><td class="textright"><?php echo  $m_langpackage->m_goods_number;?>：</td>
					<td><input type="type" name="goods_number" value="<?php echo  $goods_info['goods_number'];?>" style="width:80px; text-align:right;" maxlength="5" /> <?php echo  $m_langpackage->m_jian;?></td></tr>
				<tr><td class="textright"><?php echo  $m_langpackage->m_keyword;?>：</td>
					<td><input type="type" name="keyword" value="<?php echo  $goods_info['keyword'];?>" style="width:250px;" maxlength="200" />  <?php echo $m_langpackage->m_more_keyword_exp;?></td></tr>
				...
				<tr><td colspan="2" class="center"><input type="submit" name="submit" value="<?php echo  $m_langpackage->m_add_goods;?>" /></td></tr>
			</table>
		</form>
    </div>
    <div class="clear"></div>
