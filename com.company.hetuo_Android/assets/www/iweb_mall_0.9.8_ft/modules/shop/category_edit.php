...
<div class="container">
    ...
    <div class="apart">
		...
		<div class="title_uc"><h3><span style="float:right; margin-right:15px;"><a href="modules.php?app=shop_category" style="color:#F67A06;">
			<?php echo  $m_langpackage->m_ucategory;?></a>&nbsp;&nbsp;</span><?php echo  $m_langpackage->m_edit_ucategory;?></h3></div>
		...
		<table width="98%" class="form_table">
			...
			<tr><td colspan="2" class="center"><input type="hidden" name="shop_cat_id" value="<?php echo  $v['shop_cat_id'];?>" /><input type="hidden" name="shop_id" value="<?php echo  $shop_id;?>" /><input type="submit" name="submit" value="<?php echo  $m_langpackage->m_edit_ucategory;?>" /></td></tr>
		</table>
		</form>
        </div>
    </div>
