    ...
    <div class="apart">
		...
		<table width="98%" class="form_table">
			<tr>
				...
				<td class="textleft"><?php echo $payment['pay_name'];?><input type="hidden" name="pay_id" value="<?php echo $payment['pay_id'];?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<?php  }else {?>
				<input type="text" name="pay_config[<?php echo $k;?>]" value="" style="width:200px;" />
				<?php }?>
				</td>
			</tr>
			<?php }?>
