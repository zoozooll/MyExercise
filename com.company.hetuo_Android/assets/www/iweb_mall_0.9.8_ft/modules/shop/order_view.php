...
<div class="container">
    ...
    <div class="apart">
		...
		<div class="bigpart">
		<div class="title_uc"><h3><span style="float:right; margin-right:15px;"><a href="modules.php?app=shop_my_order" style="color:#F67A06;"><?php echo  $m_langpackage->m_recver_order;?></a>&nbsp;&nbsp;</span><?php echo  $m_langpackage->m_order_info;?></h3></div>
		<div id="reg_step">
			<ol>
			<?php  if($info['order_status']==0) {?>
				<li class=""><strong class="first">1、<?php echo $m_langpackage->m_buy_mk_order;?></strong></li><li class=""><span>2、<?php echo $m_langpackage->m_buyer_pay;?></span></li><li class=""><span>3、<?php echo $m_langpackage->m_check_put_goods;?></span></li><li class="current_prev"><span>4、<?php echo $m_langpackage->m_buyer_checkget_goods;?></span></li><li class="last_current"><span>5、<?php echo $m_langpackage->m_thisorder_cancel;?></span></li>
			<?php  } elseif($info['order_status']==3) {?>
				<li class=""><strong class="first">1、<?php echo $m_langpackage->m_buy_mk_order;?></strong></li><li class=""><span>2、<?php echo $m_langpackage->m_buyer_pay;?></span></li><li class=""><span>3、<?php echo $m_langpackage->m_check_put_goods;?></span></li><li class="current_prev"><span>4、<?php echo $m_langpackage->m_buyer_checkget_goods;?></span></li><li class="last_current"><span>5、<?php echo $m_langpackage->m_com_deal;?></span></li>
			<?php  } elseif($info['transport_status']==1) {?>
				<li class=""><strong class="first">1、<?php echo $m_langpackage->m_buy_mk_order;?></strong></li><li class="current_prev"><span>2、<?php echo $m_langpackage->m_buyer_pay;?></span></li><li class="current"><span>3、<?php echo $m_langpackage->m_check_put_goods;?></span></li><li class=""><span>4、<?php echo $m_langpackage->m_buyer_checkget_goods;?></span></li><li class="last"><span>5、<?php echo $m_langpackage->m_com_deal;?></span></li>
			<?php  } elseif($info['pay_status']==1) {?>
				<li class="current_prev"><strong class="first">1、<?php echo $m_langpackage->m_buy_mk_order;?></strong></li><li class="current"><span>2、<?php echo $m_langpackage->m_buyer_pay;?></span></li><li class=""><span>3、<?php echo $m_langpackage->m_check_put_goods;?></span></li><li class=""><span>4、<?php echo $m_langpackage->m_buyer_checkget_goods;?></span></li><li class="last"><span>5、<?php echo $m_langpackage->m_com_deal;?></span></li>
			<?php  } else  {?>
				<li class="current"><strong class="first">1、<?php echo $m_langpackage->m_buy_mk_order;?></strong></li><li class=""><span>2、<?php echo $m_langpackage->m_buyer_pay;?></span></li><li class=""><span>3、<?php echo $m_langpackage->m_check_put_goods;?></span></li><li class=""><span>4、<?php echo $m_langpackage->m_buyer_checkget_goods;?></span></li><li class="last"><span>5、<?php echo $m_langpackage->m_com_deal;?></span></li>
			<?php }?>
			</ol>
		</div>
		<table width="98%" class="form_table">
			...
			<tr><td><?php echo  $info['goods_name'];?></td><td><?php echo  $info['goods_price'];?><?php echo  $m_langpackage->m_yuan;?></td><td><?php echo  $info['order_num'];?></td><td><?php echo  $info['transport_price'];?><?php echo  $m_langpackage->m_yuan;?></td></tr>
			<tr><td colspan="4"><?php echo  $m_langpackage->m_order_thisbuyprice;?>:<span><?php echo  $info['order_amount'];?></span><?php echo  $m_langpackage->m_yuan;?>
			<?php if($info['order_status']==1 && $info['pay_status']==0) {?> <form action="do.php?act=shop_order_priceedit" method="post">
			&nbsp;&nbsp;<?php echo  $m_langpackage->m_order_editprice;?><input name="price" value="<?php echo  $info['order_amount'];?>" style="width:70px;" />
			<input type="hidden" name="order_id" value="<?php echo  $order_id;?>" />
			<input type="submit" name="btn" value="<?php echo  $m_langpackage->m_order_editprice;?>" />
			<?php }?>
			</td></tr>
		</table>
		...
		<table width="98%" class="form_table">
			<tr>
				<th style="background:#FFF2E6; color:#F67A06;" colspan="2">&nbsp;&nbsp;<?php echo  $m_langpackage->m_order_getsting;?></th>
			</tr>
			...
			<tr><td class="textright"><?php echo  $m_langpackage->m_stayarea;?>:</td><td><?php echo  $areas[$info['province']];?> <?php echo  $areas[$info['city']];?> <?php echo  $areas[$info['district']];?></td></tr>
		...
		<table width="98%" class="form_table">
			<tr>
				<th style="background:#FFF2E6; color:#F67A06;" colspan="2">&nbsp;&nbsp;<?php echo  $m_langpackage->m_order_poststing;?></th>
			</tr>
		...
		<table width="98%" class="form_table">
			<tr>
				<th style="background:#FFF2E6; color:#F67A06;" colspan="2">&nbsp;&nbsp;<?php echo  $m_langpackage->m_order_info;?></th>
			</tr>
			...
			<tr><td class="center" colspan="2">
				...
				<a href="do.php?act=shop_order_check&id=<?php echo  $info['order_id'];?>" onclick="return confirm('<?php echo  $m_langpackage->m_sure_thisorder;?>');">[<?php echo  $m_langpackage->m_sure_ordernow;?>]</a>
				<?php }?>

				<?php   if($info['transport_status']==0){?>
						<?php  if($info['pay_id']==1){?>
						<a href="do.php?act=shop_order_checkput&id=<?php echo  $info['order_id'];?>">[<?php echo  $m_langpackage->m_sure_shippingnow;?>]</a>
						<?php  } elseif($info['pay_id']==2) {?>
