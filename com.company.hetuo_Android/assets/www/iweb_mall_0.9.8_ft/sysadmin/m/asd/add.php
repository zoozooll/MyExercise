...
<div id="maincontent">
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_asd_management;?> &gt;&gt; <?php echo $a_langpackage->a_add_asd; ?></div>
        <hr />
	<div class="infobox">
    ...
    <div class="content2">
		<form action="a.php?act=asd_add" method="post" onsubmit="return checkform();" enctype="multipart/form-data">
		<table>
			<tr>
			...
			<tr>
				<td colspan="2"><span class="button-container"><input class="regular-button" type="submit" name="submit" value="<?php echo $a_langpackage->a_add_asd; ?>" /></span></td>
			</tr>
		</table>
		</form>
	  </div>
...
function checkform() {
	...
	if(c_content.value=='') {
		alert("<?php echo $a_langpackage->a_pls_asdcontent_notnull; ?>");
		return false;
	}
