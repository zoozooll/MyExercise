...
href="<?=site_url('globals/index/chi');?>"> 首页 </a></li>
<li><a title="Banking" 
href="<?=site_url('globals/company/chi');?>">公司简介</a></li>
<li><a title="Investments" 
href="<?=site_url('globals/prolist/chi');?>">产品介绍</a></li>
<li ><a title="Cards" 
href="<?=site_url('globals/infolist/chi');?>">技术资料</a></li>
<li><a title="Mortgages" 
href="<?=site_url('globals/news/chi');?>">新闻中心</a></li>
<li><a title="Mortgages" 
href="<?=site_url('globals/contact/chi');?>">联系我们</a></li>
<li class="extRightAlignTab extNoTab">
</li>
<li class="extRightAlignTab extNoTab"><a 
href="<?=site_url('globals/index/eng');?>"
