function postBoard(){
	...
	ajax.send('mode.php?m=o&q=ajax&a=postboard','&uid='+uid+'&title='+ajax.convert(title),function(){
...
function delBoard(bid){
	...
	ajax.send('mode.php?m=o&q=ajax&a=delboard','id='+bid,function(){
...
function creatBoard(container,bid,face,title){
	...
	postdate_span.innerHTML = thispost+'留言道：';
