...
EOT;
	...
	'9' => array(
		...
		'name' => '首页播放器',
		'tplid' => '11',
		'tagcode' => '<div id="pwSlidePlayer" class="pwSlide cc" onmouseover="pwSlidePlayer(\'pause\');" onmouseout="pwSlidePlayer(\'goon\');">
<!--#
	$tmpCount=0;
#-->
...
#-->
		...
		'parsecode' => '<div id="pwSlidePlayer" class="pwSlide cc" onmouseover="pwSlidePlayer(\'pause\');" onmouseout="pwSlidePlayer(\'goon\');">
<!--#
	$tmpCount=0;
#-->
EOT;
