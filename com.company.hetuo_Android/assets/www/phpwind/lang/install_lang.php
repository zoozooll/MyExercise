...
$lang = array(
	...
	'dbpconnect'		=> '是否持久连接',
	'dbpre'				=> '表区分符',
	'dbpres'			=> '数据库表前缀<br />非必要<b>请保持默认</b>',
	'dbpw'				=> '数据库密码',
	'dbuser'			=> '数据库用户名',
	...
	'error_unfind'		=> '<b>{#filename}</b> 文件或文件夹不存在，请上传此文件',
	'error_unfinds'		=> '<b>{#filenames}</b> 等文件或文件夹不存在，请上传此文件',
	...
	'log_install'		=> '<p>1、运行环境需求：PHP+MYSQL</p><p>2、安装步骤</p><p>● Linux 或 Freebsd 服务器下安装方法</p>
		...
		<div style="padding:.5em 2em">
			...
			<span class="black" style="width:250px; float:left">htm_data</span><span class="black" style="padding-right:2em">data/tplcache</span><br/>
			<span class="black" style="width:250px; float:left">&nbsp;</span><span class="black" style="padding-right:2em">data/forums</span><br/>
		</div>
	...
	'success_install'	=> '恭喜您，您的 PHPWind V{#wind_version} SP3优化版 已经安装成功！',
	'success_repair'	=> '恭喜您，您的 PHPWind V{#wind_version} SP3优化版 已经更新成功！',
	'success_upto'		=> '恭喜您，您的 PHPWind V{#wind_version} SP3优化版 已经升级成功！',
	...
	'left_info'			=> '<dt style="margin:0;">更新记录</dt>
        <dd style="padding-top:5px;"><a href="http://www.phpwind.net/read-htm-tid-824891.html" target="_blank">PHPWind 7.5 更新列表</a></dd>
        ...
        <dt>帮助文档</dt>
        <dd style="padding-top:5px;"><a href="http://www.phpwind.net/read.php?tid=964434&page=1&toread=1#tpc" target="_blank">安装教程</a></dd>
		<dd><a href="http://www.phpwind.net/read.php?tid=964444&page=1&toread=1#tpc" target="_blank">升级教程</a></dd>
		<dd><a href="http://www.phpwind.net/read-htm-tid-839361.html" target="_blank">插件安装教程</a></dd>
        <dd><a href="http://www.phpwind.net/read-htm-tid-840315.html" target="_blank">风格安装教程</a></dd>
        <dd><a href="http://www.phpwind.net/read-htm-tid-839222.html" target="_blank">数据库结构手册</a></dd>
        <dd><a href="http://www.phpwind.net/read-htm-tid-838203.html" target="_blank">在线反馈</a></dd>
...
############################## SQL LANG ##############################
	...
	'helpd_10'			=> '在帖子列表页面和帖子阅读页面，点击“新帖”图标进入主题帖发布页面，发帖时在帖子编辑器下方找到“出售此帖”，在前面的复选框理勾选（如果复选框呈灰色，说明该版块不允许发布交易帖或者您的权限不够），填写好会员读帖需要支付的金钱数量（注意不能超过支付最大值）。\n同样，也可以在帖子列表页面底部的快速发帖模块进行发帖操作时设置读帖需要支付的金钱数量。',
	...
	'helpd_16'			=> '读一个出售帖时，首先要在点击“购买”按钮，如果金钱数大于购买帖子所需的数量，就会扣掉相应的金钱数，同时购买成功，可以阅读到帖子内容。',
	...
	'tool_1'			=> '威望工具',
	'tool_1_inro'		=> '可将自已负威望清零',
	'tool_2'			=> '清零卡',
	'tool_2_inro'		=> '可将自已所有负分清零,包括金钱,威望,贡献值,积分',
	'tool_3'			=> '醒目卡',
	...
	'mode_area_header_f'=> '升级之前请先删除mode/area/template/目录下的header.htm、footer.htm文件',
	...
	'install_initdata'	=> '<h4><span class="fr h4-zy">正在初始化数据,请稍候...</span><span class="fl"><img src="lang/images/jinggao.gif" align="absmiddle"/> </span></h4>',
