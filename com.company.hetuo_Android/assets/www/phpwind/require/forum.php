...
function headguide($guidename,$onmouseover=true) {
	global $db_menu,$db_bbsname,$db_bfn,$cateid,$fid,$imgpath,$stylepath,$db_menu,$db_mode,$db_bbsurl;
	...
	if ($db_menu && $onmouseover) {
		$headguide = "<img style=\"cursor:pointer\" id=\"td_cate\" src=\"$imgpath/$stylepath/thread/home.gif\"  onClick=\"return pwForumList(false,false,null,this);\" align=\"absmiddle\" /> <a href=\"$db_bfn_temp\" title=\"$db_bbsname\">$db_bbsname</a>" ;
	} else{
