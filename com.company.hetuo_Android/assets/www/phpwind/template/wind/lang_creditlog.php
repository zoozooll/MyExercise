...
$lang['creditlog'] = array (
	...
	* 评分相关操作
	*/
	'credit_showping'	=> '[b]{$L[username]}[/b] 发表的文章：[url={$GLOBALS[db_bbsurl]}/read.php?tid={$L[tid]}]{$L[subject]}[/url] 被 [b]{$L[operator]}[/b] 评分。\n原因：{$L[reason]}\n奖励积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',
	'credit_delping'	=> '[b]{$L[username]}[/b] 发表的文章：[url={$GLOBALS[db_bbsurl]}/read.php?tid={$L[tid]}]{$L[subject]}[/url] 被 [b]{$L[operator]}[/b] 取消评分。\n原因：{$L[reason]}\n扣除积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',
	...
	* 群组相关
	*/
	'groups_Uploadphoto'=> '[b]{$L[username]}[/b] 上传相片增加积分。\n增加积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',
	'groups_Deletephoto'=> '[b]{$L[username]}[/b] 删除相片扣除积分。\n扣除积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',
	...
	* 相册相关
	*/
	'photos_Deletephoto'=> '[b]{$L[username]}[/b] 删除相片扣除积分。\n扣除积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',
	'photos_Uploadphoto'=> '[b]{$L[username]}[/b] 上传相片增加积分。\n增加积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',
	'photos_Createalbum'=> '[b]{$L[username]}[/b] 创建相册扣除积分。\n扣除积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',

	/*
	* 记录相关
	*/
	'write_Post'=> '[b]{$L[username]}[/b] 发表记录增加积分。\n增加积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',
	'write_Delete'=> '[b]{$L[username]}[/b] 删除记录扣除积分。\n扣除积分：[b]{$L[cname]}[/b]，影响：{$L[affect]}。',
