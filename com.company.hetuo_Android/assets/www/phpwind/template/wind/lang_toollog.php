...
$lang['toollog'] = array (
	...
	'tool_3_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 加亮显示。',

	'tool_4_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 在版块中置顶。',

	'tool_5_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 在所在分类中置顶。',

	'tool_6_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 在整个论坛中置顶。',

	'tool_7_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 提前到该版块首页。',

	'tool_8_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将自己在论坛的用户名改为[b]{$L[newname]}[/b]。',

	'tool_9_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 加为精华I。',

	'tool_10_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 加为精华II。',

	'tool_11_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 锁定。',

	'tool_12_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 解除锁定。',

	'tool_13_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 支持度加1。',

	'tool_14_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 反对度加1。',
	...
	'tool_17_descrip'	=> '[b]{$L[username]}[/b] 使用道具 [b]{$L[toolname]}[/b] ,将帖子 [url=$db_bbsurl/read.php?tid=$L[tid]][b]$L[subject][/b][/url] 停止在12小时以前。',
