...
function ShowPop(popParam,popCode){
	...
	popup.innerHTML="<table cellspacing=0 cellpadding=0 width=100%><tr><td class='h'><a id='closeButton' title='close' class='fr' onclick='hidePop();'><img src='images/close.gif' /></a>"+popParam.title+"</td></tr><tr class='f_one'><td>" + popCode + "</td></tr></table>";
