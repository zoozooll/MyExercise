	...
	<div id="register" style="border:#9AD5F2 1px solid; border-top:#FFF 1px solid;">
      <div id="regcomd">
		<div class="boxcoml">
			...
			<div style="padding-left:150px; padding-bottom:20px;"><?php if($this->__muant["reg_success"]=='yes') { ?><?php include("#reg_success.tpl.php") ?><?php } else { ?><?php include("#reg_info.tpl.php") ?><?php } ?></div>
		</div>
		<div class="cl"></div>
	  </div>
	</div>
