...
<ul class="related">
<?php if($this->__muant["$ProductRelated "]!=$this->__muant[" NULL"]) { ?>
<div id="xgprotit">&nbsp;相关产品</div>
<!--<div id=prorelt>-->
<div style="float:left;width:<?php echo $this->__muant["ProductRelatedWidth"] ?>px; border-left:1px solid #EAEAEA;border-top:1px solid #EAEAEA;border-bottom:1px solid #EAEAEA; text-align:center;">
		...
		{section name=index loop=$ProductRelated}
			<td width="15%" class="td_main">
				...
				<div style="vertical-align:bottom; height:80px;">
					<?php if($this->__muant["$ProductRelated[index]"]["r_MerchantCount "]> 1) { ?>
