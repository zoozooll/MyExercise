...
<div id="wrapper">
    ...
    <!-- -->
    <div id="container"><div class='mallLogin'> <span class='welcome'><?php echo $this->__muant["__Meta"]["Site"] ?></span></div>
        <div class="content">  
              <div class="compareList">
                <ul class="shoppingTab" style="width:945px;">
                  <li class="cur" id="tab1"><?php echo $this->__muant["__Meta"]["Site"] ?></li>
                </ul>
                <div id="con1">
                    <div style="float:left; width:250px;">
                       <div id="divClassUB"><a href="./faq.php" class="gy">什么是<?php echo $this->__muant["__Meta"]["Site"] ?></a></div>
                    ...
                    <div style="float:left; width:650px;">       
                        <?php echo $this->__muant["shop_about_all"] ?>
                    </div>
              </div>
            </div>
        </div>    
