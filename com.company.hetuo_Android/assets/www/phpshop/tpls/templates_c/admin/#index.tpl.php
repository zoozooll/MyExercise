...
<div id="dvTop">
 <div id="divTopMsg">
	...
	<div id="divUsrMsg" class="fLeft">
	  您好，<b><?php echo $this->__muant["admin_name"] ?></b> [ <a href="./admin/checklogin.php?logout=yes" class="toplink">退出</a>，
	...
	<?php $admin_menuinum = count($this->__muant["admin_menu"]); for($admin_menui = 0; $admin_menui<$admin_menuinum; $admin_menui++) { ?>
		...
		<a href="javascript:void(0)" id="amenu<?php echo $this->__muant["admin_menu"]["$admin_menui"]["id"] ?>" class="<?php if($this->__muant["admin_menu"]["$admin_menui"]["id"]==$this->__muant["mid"]) { ?>navOn f14e<?php } elseif($this->__muant["admin_menu"]["$admin_menui"]["id"]=='1') { ?>navOn f14e<?php } elseif($this->__muant["admin_menu"]["$admin_menui"+1]["id"]>'0') { ?>navNml f14c<?php } else { ?>last f14c<?php } ?>" ><?php echo $this->__muant["admin_menu"]["$admin_menui"]["name"] ?></a>
			<ul><?php } ?><?php if($this->__muant["admin_menu"]["$admin_menui"]["orderid"]>0) { ?>
				<li> <a href="/admin#" onClick="show('','<?php echo $this->__muant["admin_menu"]["$admin_menui"]["fsid"] ?>','<?php echo $this->__muant["admin_menu"]["$admin_menui"]["id"] ?>'); return false" id="aMenuInbox"><?php echo $this->__muant["admin_menu"]["$admin_menui"]["name"] ?></a></li><?php } ?><?php if($this->__muant["admin_menu"]["$admin_menui"+1]["orderid"]==0) { ?>
			</ul>
		</li>
		<?php } ?>
	<?php } ?>
    	<!--li id="admin_menu"><a href="javascript:void(0)" class="f14c">快捷菜单</a>
        	<ul><div>
            <?php $admin_menuinum = count($this->__muant["admin_menu"]); for($admin_menui = 0; $admin_menui<$admin_menuinum; $admin_menui++) { ?><?php if($this->__muant["admin_menu"]["$admin_menui"]["orderid"]==0) { ?><b><?php } ?><?php if($this->__muant["admin_menu"]["$admin_menui"]["orderid"]>0) { ?><a href="javascript:void(0);" onClick="show('','<?php echo $this->__muant["admin_menu"]["$admin_menui"]["fsid"] ?>','<?php echo $this->__muant["admin_menu"]["$admin_menui"]["id"] ?>'); return false"><?php } ?><?php echo $this->__muant["admin_menu"]["$admin_menui"]["name"] ?><?php if($this->__muant["admin_menu"]["$admin_menui"]["orderid"]>0) { ?></a><?php } ?><?php if($this->__muant["admin_menu"]["$admin_menui"]["orderid"]=='0') { ?>→</b><?php } ?>　<?php } ?>
            </div></ul>
        </li-->
    </ul>
    <div id="divSearch">
...
<!-- bottom -->
<iframe id="adminMain" name="adminMain" src="admincp.php?mid=<?php echo $this->__muant["mid"] ?>&lid=<?php echo $this->__muant["lid"] ?>" frameborder="0" width="100%" height="350" onload="Javascript:SetWinHeight(this)"></iframe>
<div class="cls"></div>
<div id="bottom"></div>
