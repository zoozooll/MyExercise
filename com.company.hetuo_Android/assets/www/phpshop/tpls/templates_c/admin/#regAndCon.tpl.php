...
<div id="BodyContent">
	...
	<div id="divMainBodyContent">
		<div id="divMainBodyContentTitle"> 什么是<?php echo $this->__muant["__Meta"]["Site"] ?>:</div>
	    <div class="fLeft" style="height:300px;"><textarea id="value1" name="value1"  rows="15" cols="35" style="width:98%"><?php echo $this->__muant["value"]["value1"] ?></textarea>
		</div>
		<div class="cls"></div>
    </div>
	<div id="divMainBodyContent">
		<div id="divMainBodyContentTitle"> 友情链接:</div>
	    <div class="fLeft" style="height:300px;"><textarea id="value2" name="value2"  rows="15" cols="35" style="width:98%"><?php echo $this->__muant["value"]["value2"] ?></textarea>
		</div>
		<div class="cls"></div>
    </div>
	<div id="divMainBodyContent">
		<div id="divMainBodyContentTitle"> 联系我们:</div>
	    <div class="fLeft" style="height:300px;"><textarea id="value3" name="value3"  rows="15" cols="35" style="width:98%"><?php echo $this->__muant["value"]["value3"] ?></textarea>
		</div>
		<div class="cls"></div>
    </div>
	<div id="divMainBodyContent">
		<div id="divMainBodyContentTitle"> 订购方式:</div>
	    <div class="fLeft" style="height:300px;"><textarea id="value4" name="value4"  rows="15" cols="35" style="width:98%"><?php echo $this->__muant["value"]["value4"] ?></textarea>
		</div>
		<div class="cls"></div>
    </div>
	<div id="divMainBodyContent">
		<div id="divMainBodyContentTitle"> 送货方式:</div>
	    <div class="fLeft" style="height:300px;"><textarea id="value5" name="value5"  rows="15" cols="35" style="width:98%"><?php echo $this->__muant["value"]["value5"] ?></textarea>
		</div>
		<div class="cls"></div>
    </div>
	<div id="divMainBodyContent">
		<div id="divMainBodyContentTitle"> 付款方式:</div>
	    <div class="fLeft" style="height:300px;"><textarea id="value6" name="value6"  rows="15" cols="35" style="width:98%"><?php echo $this->__muant["value"]["value6"] ?></textarea>
		</div>
		<div class="cls"></div>
    </div>
	<div id="divMainBodyContent">
		<div id="divMainBodyContentTitle"> 服务保证:</div>
	    <div class="fLeft" style="height:300px;"><textarea id="value7" name="value7"  rows="15" cols="35" style="width:98%"><?php echo $this->__muant["value"]["value7"] ?></textarea>
		</div>
		<div class="cls"></div>
    </div>
</div>	
...
<div id="divMainBodyContent">
	<div id="divMainBodyContentTitle"> </div>
	<div class="fLeft" style="height:20px;"></div>
	<div class="cls"></div>
</div>
</body></html>