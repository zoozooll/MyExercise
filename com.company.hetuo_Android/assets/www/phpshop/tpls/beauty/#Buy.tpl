...
{else}
   ...
   <div id="chanl" style="margin-top:5px;">
		...
		{inc file=#Shop_Product_Detailed.tpl}  
		</div>
		...
		<div id="orderpay">             
				...
				{$loop freight}
				<li id="pay">
				<input type="radio" value="{$freight.loop.id}" id="freight" name="freight" > {$freight.loop.name} {if freight.loop.freight>0}{if freight.loop.shop_price>0}{if allprice>=freight.loop.shop_price}免运费{else}价格：{$freight.loop.freight}元{/if}{else}价格：{$freight.loop.freight}元{/if}{else}免运费{/if} {$freight.loop.describes}
				</li>   
				{/loop} 
				</ul>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="261">
			  <tr> 
				...
				<td width="443" bgcolor="#ecf5ff" height="31">
				  <input size="27" name="name" value="{$userinfo.name}" maxlength="20" >
			  ...
			  <tr> 
				...
				<td width="443" bgcolor="#ecf5ff" height="30">
				  <input size="41" name="address" value="{$userinfo.address}" maxlength="50">
				  <font color="red">*</font></td>                                          
			  </tr>
			   <tr> 
				<td width="153" height="30" align="right" valign="middle" bgcolor="#ecf5ff" style="text-align:right; font-size:14px;">
				  邮编:&nbsp;&nbsp;</td>
				<td width="443" bgcolor="#ecf5ff" height="30">
				  <input size="20" name="postcode" value="{$userinfo.postcode}" maxlength="50">
				 </td>                                          
			  </tr>
			  <tr> 
				<td width="153" height="30" align="right" valign="middle" bgcolor="#ecf5ff" style="text-align:right; font-size:14px;">
				...
				<td bgcolor="#ecf5ff" height="32" width="443"><font size="2"> 
				  <input size="27" name="phone" value="{$userinfo.phone}" maxlength="20">
			  ...
			  <tr> 
				...
				<td width="443" bgcolor="#ecf5ff" height="31"> 
				  <input name="mobile" size="27" maxlength="15" value="{$userinfo.mobile}">
				</td>
			  </tr>
			  <tr> 
				<td width="153" height="30" align="right" valign="middle" bgcolor="#ecf5ff" style="text-align:right;">
				  * E-Mail:&nbsp;&nbsp;</td>                     
				<td width="443" bgcolor="#ecf5ff" height="30">
				  <input size="30" name="email" value="{$userinfo.email}" maxlength="50">
				  <font color="red">*</font></td> 
			  </tr>
			  <tr> 
