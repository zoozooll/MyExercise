...
<div id="BodyContent">
	...
	<div id="divMainBodyContent">
	  ...
	  <div class="fLeft">&nbsp;<!--input name="value2" type="text" class="txInput" id="value2" value="{$value.value2}" -->
		...
		<div><iframe src="./admin/adminajaxset.php?switch=uploadwaterimg&lid={$lid}" width="380" frameborder="0" height="25" allowTransparency='true' name="uploadpic"></iframe></div>
    </div>
</div>
