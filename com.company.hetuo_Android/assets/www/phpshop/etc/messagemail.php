<?php 
$messagemail = '<table border="1" width="100%" bordercolor="#017ABC" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin:0px; padding:0px;">
  <tr>
	<td width="100%" align="center">    
<table  width="100%" height="129" cellspacing="1" cellpadding="1" >
  <TR BGCOLOR=#CEE3D0 > 
	<TD height="32" align="left" bgcolor="#0789E9" style="font-size:16px; font-weight:600; color:#FFFFFF; padding:5px; font-family:\'幼圆\', \'宋体\', \'黑体\';">'.$shop_web_name .' ( '.$title.' )</td>
	</TR>
