...
<?=form_open_multipart('backend/product/edit', '', array('id' => $data[0]->id));?>
        <fieldset class="w450">
            ...
            <div class="lable_input_set">
                <label class="input_label w10">产品编号(中):</label>
            ...
            <div class="lable_input_set">
                ...
                <textarea rows="5	" cols="20" class="text_input w15" name="trait_eng"><?=$data[0]->trait_eng?></textarea>
            </div>
            <div class="lable_input_set">
                <label class="input_label w10">产品特点(中):&nbsp;&nbsp;</label>
                <textarea rows="5	" cols="20" class="text_input w15" name="trait_chi"><?=$data[0]->trait_chi?></textarea>
            </div>
            <div class="lable_input_set">
            <label class="input_label w10">应用领域(英):&nbsp;&nbsp;</label>
                <textarea rows="5	" cols="20" class="text_input w15" name="app_eng"><?=$data[0]->app_eng?></textarea>
            </div>
            <div class="lable_input_set">
            <label class="input_label w10">应用领域(中):&nbsp;&nbsp;</label>
                <textarea rows="5	" cols="20" class="text_input w15" name="app_chi"><?=$data[0]->app_chi?></textarea>
            </div>
 						<div class="lable_input_set">
            ...
            <div class="lable_input_set">
                <label class="input_label w10">技术参数:
                <img src="<?=base_url();?>system/images/backend/uploads/<?=$data[0]->img2?>" width="80" heigth = "80"/>
                </label>
                <input class="text_input w15" type="file" name="img[]"/>
            </div>
             <div class="lable_input_set">
