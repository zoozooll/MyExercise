...
<table class="maintable" height="400" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="left_menu" valign="top"><h5><a href="./" onclick="return confirm('离开此页面将无法编辑')">论坛首页</a> &gt; 修改已发信息 &gt; 选择类目 &gt;</h5>
...
<div id="foot"><a href="contact.php" onclick="return confirm('离开此页面将无法编辑')">联系我们</a> - 2008-2009 YZSOU All Rights Reserved</div>
</body>
</html>
