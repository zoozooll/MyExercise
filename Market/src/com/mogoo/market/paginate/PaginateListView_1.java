...
public class PaginateListView_1<T> extends ListView implements
		IStreamRspProcessor {
	...
	public PaginateListView_1(Context context){
		super(context);
		setDividerHeight(0);
	}
	public PaginateListView_1(Context context, ArrayAdapter adapter) {
		super(context);
		mContext = context;
	...
	public PaginateListView_1(Context context, CursorAdapter adapter, IBeanDao<T> beanDao, String url) {
		super(context);
		mUrl = url;
		mContext = context;
		mPaginateAdapter = adapter;
			...
			((CommonEmptyView) emptyView)
					.setRefreshListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							PaginateListView_1.this.emptyView.forceRefresh();
