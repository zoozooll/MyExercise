...
public class ScanSdCardUtils {
	...
	public  ArrayList<SdcardInstalledAppInfo> myFiles = new ArrayList<SdcardInstalledAppInfo>();
...
//	}
	...
	public List<SdcardInstalledAppInfo> getMyFiles() {
		return myFiles;
	}

	public void setMyFiles(ArrayList<SdcardInstalledAppInfo> myFiles) {
		...
		if (file.isFile()) {
			...
			if (name_s.toLowerCase().endsWith(".apk")) {
				...
				if(packageInfo!=null){
				   ...
				   myFile = new SdcardInstalledAppInfo(mContext,packageInfo);
