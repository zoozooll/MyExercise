...
public class SizeLimitActivity extends Activity
    ...
    private void showDialog(Cursor cursor) {
        ...
        int button_queue_for_wifi = Helpers.getResourseIdByName(
				getPackageName(), "string", "button_queue_for_wifi");
        
        int wifi_required_title = Helpers.getResourseIdByName(
				getPackageName(), "string", "wifi_required_title");
        
        int wifi_required_body = Helpers.getResourseIdByName(
				getPackageName(), "string", "wifi_required_body");
        
        int button_cancel_download = Helpers.getResourseIdByName(
				getPackageName(), "string", "button_cancel_download");
        int wifi_recommended_title = Helpers.getResourseIdByName(
				getPackageName(), "string", "wifi_recommended_title");
        int wifi_recommended_body = Helpers.getResourseIdByName(
				getPackageName(), "string", "wifi_recommended_body");
        int button_start_now = Helpers.getResourseIdByName(
				getPackageName(), "string", "button_start_now");
        
        //String queueText = getString(R.string.button_queue_for_wifi);
        String queueText = getString(button_queue_for_wifi);
...
//                    .setNegativeButton(R.string.button_cancel_download, this);
        	...
        	builder.setTitle(wifi_required_title)
            	.setMessage(getString(wifi_required_body, sizeString, queueText))
            	.setPositiveButton(button_queue_for_wifi, this)
            	.setNegativeButton(button_cancel_download, this);
        } else {
            builder.setTitle(wifi_recommended_title)
                    .setMessage(getString(wifi_recommended_body, sizeString, queueText))
                    .setPositiveButton(button_start_now, this)
                    .setNegativeButton(button_queue_for_wifi, this);
        }
