...
public class BookShelfRecommendListByAdapter extends PageListAdapter<RecommentInfor> {
	...
	public BookShelfRecommendListByAdapter(Context context,
	...
	public View initItemView(View convertView, Object item, int position) {
		...
		convertView = inflater.inflate(R.layout.bookshelf_recommendby_child, null);
		...
		holder.reason = (TextView) convertView.findViewById(R.id.bookshelfrecommend_contentby);
		holder.recommendDate = (TextView) convertView.findViewById(R.id.bookshelfgift_gifttime);
		holder.bookshelfrecommend_contentbyall=(TextView)convertView.findViewById(R.id.bookshelfrecommend_contentbyall);
		holder.bookshelfrecommend_contentby=(TextView)convertView.findViewById(R.id.bookshelfrecommend_contentby);
...
//			holder.gift.setOnClickListener(itemViewOclickEvent);
			...
			if(recomment.getReason().length()>20){
				((TextView)convertView.findViewById(R.id.bookshelfrecommend_contentby)).setHeight(35);
				((TextView)convertView.findViewById(R.id.bookshelfrecommend_contentbyall)).setVisibility(View.VISIBLE);
			}
			else{
				((TextView)convertView.findViewById(R.id.bookshelfrecommend_contentbyall)).setVisibility(View.GONE);
			}
//		    
			holder.bookshelfrecommend_contentbyall.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					if(boolAll==true)
					{
					holder.bookshelfrecommend_contentby.setHeight(100);
					holder.bookshelfrecommend_contentbyall.setText("收起");
					boolAll=false;}
					else{
						holder.bookshelfrecommend_contentby.setHeight(35);
						holder.bookshelfrecommend_contentbyall.setText("查看全部");
						boolAll=true;	
					}
				}
			});
//			holder.gift.setOnClickListener(itemViewOclickEvent);
	...
	private class ViewHolder {
		...
		public TextView recommendDate;//时间	
		public TextView reason;//原因
		public TextView bookshelfrecommend_contentbyall,bookshelfrecommend_contentby;
