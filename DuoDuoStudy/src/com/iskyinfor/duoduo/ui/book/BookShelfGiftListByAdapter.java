...
public class BookShelfGiftListByAdapter extends PageListAdapter<RecommentInfor> {
	...
	public BookShelfGiftListByAdapter(Context context,
	...
	public View initItemView(View convertView, Object item, int position) {
		...
		convertView = inflater.inflate(R.layout.bookshelf_giftby_child, null);
...
//			holder.gift.setOnClickListener(itemViewOclickEvent);
	...
	private class ViewHolder {
		...
		public TextView recommendDate;//时间	
		public TextView reason;//原因
		public TextView bookshelfgift_content,bookshelfgift_contentall;
	}
