...
import static com.mogoo.ping.ctrl.GridSoftwaresController1.*;
/**
 * @author Aaron Lee
 * TODO
 * @Date 下午5:49:13  2012-11-1
 */
public class TabWidgetController1 implements OnTabChangeListener  {
	...
	private TabContentController1 mTabContentApplicationsController;
	private TabContentController1 mTabContentGamesController;
	...
	public TabWidgetController1(Activity activity,TabHost tabHost, TabWidget tabWidget) {
		super();
		mActivity = activity;
		mTabHost = tabHost;
	...
	private void init() {
		...
		mTabContentApplicationsController =  new TabContentController1(mActivity, layout_tab_content_applications);
		mTabContentApplicationsController.setContentSyncThreads(TAG_APPLICATIONS_LASTED, TAG_APPLICATIONS_RECOMEND, TAG_APKS_USED);
		mTabContentGamesController = new TabContentController1(mActivity, layout_tab_content_game);
		mTabContentGamesController.setContentSyncThreads(TAG_GAME_LASTED, TAG_GAME_RECOMEND, TAG_APKS_USED);
	...
	public void onTabChanged(String tabId) {
		if (TAB_SPEC_APPLICATIONS.endsWith(tabId)) {
			mTabContentApplicationsController.beginShowingInfront();
		} else if (TAB_SPEC_GAMES.endsWith(tabId)) {
			mTabContentGamesController.beginShowingInfront();
