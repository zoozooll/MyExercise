        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (Math.abs(deltaX) > mViewWidth / 2) {
                    ...
                    Log.d("SwipeDismissListViewTouchListener---1","dismissRight:"+dismissRight+" ,deltaX:"+deltaX+",mViewWidth:"+mViewWidth);
                } else if (mMinFlingVelocity <= velocityX && velocityX <= mMaxFlingVelocity
                        && velocityY < velocityX) {
                    dismiss = true;
                    dismissRight = mVelocityTracker.getXVelocity() > 0;
                    Log.d("SwipeDismissListViewTouchListener---2","velocityX:"+velocityX+",velocityY:"+velocityY+",dismissRight:"+dismissRight+",mVelocityTracker.getXVelocity():"+mVelocityTracker.getXVelocity());
                } else if(Math.abs(deltaX) < 10) { //handle click event 
                	mListView.performItemClick(mDownView, mDownPosition, mDownPosition + 1);
                	break;
                }
                if (dismiss) {
                    // dismiss
