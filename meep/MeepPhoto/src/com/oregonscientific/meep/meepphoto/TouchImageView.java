...
public class TouchImageView extends ImageView {
    ...
    public DeactivableViewPager externalPager;
	...
	public void onZoom(float scale) {
    	Log.e("onZoom","Zxxxxxxxxxxxxxxxxxxxxe"+scale);
    	externalPager = new DeactivableViewPager(getContext());
    	if(scale<=1.0){
    		externalPager.activate();
    	}else{
    		externalPager.deactivate();
    	}
	...
	public OnPageScaleListener externalScaleListener;
    ...
    public class ScaleListener1 extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
            externalScaleListener.onScaleEnd(0);
        }
    }
