...
public class AutoResizeMyTextView extends MyTextView {
	...
	public AutoResizeMyTextView(Context context) {
		super(context);
		initialize();
	}

	public AutoResizeMyTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initialize();
	}

	public AutoResizeMyTextView(Context context, AttributeSet attrs, int defStyle) {
