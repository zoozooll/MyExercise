...
public class ImageCache {
	...
	public static class SystemUtils {
		...
		// the minimum sdk version is api level 15, but jelly bean belongs to api level 16
	...
	public static File getDiskCacheDir(Context context, String uniqueName) {
		...
		File file = null;
		// modify by aaronli Mar17 2013
		// prevent nullpointerexception
		try {
			final String cachePath = Environment.MEDIA_MOUNTED
					.equals(Environment.getExternalStorageState()) || !isExternalStorageRemovable() ? getExternalCacheDir(context).getPath()
