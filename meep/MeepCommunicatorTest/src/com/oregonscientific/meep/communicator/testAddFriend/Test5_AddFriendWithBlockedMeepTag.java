...
public class Test5_AddFriendWithBlockedMeepTag
		extends
	...
	public Test5_AddFriendWithBlockedMeepTag() {
	...
	public void test5_AddFriendWithBlockedMeepTag() throws Exception {
		try {
			...
			TextView tv = (TextView) solo.findViewById(com.oregonscientific.meep.communicator.R.id.message);
			
			assertTrue("Cannot block bad word", 
					tv.getText().equals(
							solo.getString(com.oregonscientific.meep.communicator.R.string.blocked)
							)
			);
