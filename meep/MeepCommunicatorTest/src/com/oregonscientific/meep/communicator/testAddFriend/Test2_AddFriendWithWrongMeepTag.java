...
public class Test2_AddFriendWithWrongMeepTag extends
ActivityInstrumentationTestCase2<com.oregonscientific.meep.communicator.activity.CommunicatorActivity> {
	...
	public Test2_AddFriendWithWrongMeepTag() {
	...
	public void test2_AddFriendWithWrongMeepTag() throws Exception {
		try {
