...
public class BaseSingleLaunchActivityTestCase extends
		SingleLaunchActivityTestCase<HomeActivity> {

	public BaseSingleLaunchActivityTestCase() {
		super(TestData.PACKAGE_NAME, HomeActivity.class);
	}
