...
public class ListAdapterChild extends ArrayAdapter<HashMap<String, Object>> {
	private final static String TAG = "ListChild";
	private int resourceId = 0;
	private LayoutInflater inflater;
	static int i = 0;
	
	public ListAdapterChild(Context context, int resourceId, List<HashMap<String, Object>> Items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    try {
	    	...
	    	isCurrent = (ImageView)view.findViewById(R.id.isCurrentKid);
