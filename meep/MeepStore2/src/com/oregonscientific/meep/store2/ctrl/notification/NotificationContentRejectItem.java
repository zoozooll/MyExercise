...
public class NotificationContentRejectItem extends NotificationMessageItem{

	protected String parentName;
	protected String applicationName;
	public NotificationContentRejectItem(Context context,int type, String parentName,
			String applicationName) {
		super(type,context);
		this.setParentName(parentName);
		this.setApplicationName(applicationName);
		
		int messageResId = R.string.notification_message_content_rejected;
