...
public class MeepSaftyActivity extends Activity {
    /** Called when the activity is first created. */
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        
        Intent intent = new Intent(this, MeepSaftyAndHelpActivity.class);
	...
	//final String URL_MEEP_STORE = "https://store.meeptablet.com/safety";
	//2013-03-11 - raymond - add Language support
	String URL_MEEP_STORE = "https://store.meeptablet.com/safety"; 
	...
	protected void onStart() {
		...
		if(!isOnline())
		{
			showMeepPopUpMessage(R.string.safety_title_uh_oh, R.string.safety_msg_no_network);
		}
	...
	private void initWebView()
    {
    	...
    	//2013-03-11 - raymond - add Language support
    	//URL_MEEP_STORE = getText(R.string.URL_MEEP_STORE).toString();
