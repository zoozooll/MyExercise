...
public class TestAhoCorasick extends TestCase {
	...
	public void testMultipleOutputs() {
		...
		assertEquals(
				new HashSet(Arrays.asList(new String[] { "xxx", "xx", "x" })),
				result.getOutputs());
	...
	public void largerTextExample() {
		...
		assertEquals(
				new HashSet(Arrays.asList(new String[] { "cytochrome", "GA3",
						"cytochrome P450", "protein", "RNA", "gibberellin",
						"Arabidopsis", "ent-kaurene oxidase activity",
						"inflorescence", "tissue", })), termsThatHit);
