...
/**
 * Database helper class used to manage the creation and upgrading of log
 * database. This class also usually provides the DAOs used by the other
 * classes.
 */
public class LogDatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
		try {
			...
			TableUtils.createTable(connectionSource, $Log$Record.class);
