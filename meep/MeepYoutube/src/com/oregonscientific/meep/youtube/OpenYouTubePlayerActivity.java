...
public class OpenYouTubePlayerActivity extends Activity {
	...
	protected void onCreate(Bundle pSavedInstanceState) {
		...
		// Added by Aaronli for stop playing music when youtube previous to play movie.
		...
		//Intent delegate = new Intent(getBaseContext(), serviceScreen.class);
		//getBaseContext().startService(delegate);
...
//				 if (extras != null){
//					 Log.e("bb",extras.getString("screenstatus"));
//				 }
//			 }
//		 }
//	}
//	
	...
	private void setupView() {
	    ...
	    mTextView.setId(10);
	    android.widget.RelativeLayout.LayoutParams lTextViewLayoutParams = new android.widget.RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
	    lTextViewLayoutParams.addRule(RelativeLayout.CENTER_IN_PARENT);
	    mTextView.setLayoutParams(lTextViewLayoutParams);
	    lRelLayout.addView(mTextView);
	    
	    mTextView = new TextView(this);
	    mTextView.setId(11);
	    android.widget.RelativeLayout.LayoutParams lTextView2LayoutParams = new android.widget.RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
	    lTextView2LayoutParams.addRule(RelativeLayout.CENTER_IN_PARENT);
	    mTextView.setLayoutParams(lTextView2LayoutParams);
	    lRelLayout.addView(mTextView);
	}
	...
	protected void onStop() {
		super.onStop();
		//getBaseContext().stopService(new Intent(getBaseContext(), serviceScreen.class) );
	}
