...
public class AMUncaughtExceptionHandler implements UncaughtExceptionHandler
{
	...
	public AMUncaughtExceptionHandler(Context context, String path)
	{
	...
	protected boolean handleException(Thread thread, Throwable ex)
	{
		...
		// 如果是OOM，dump内存
		AMOOMHelper.dumpHprofIfNeeded(mContext, ex);
		return true;
	}
