...
import static com.tcl.manager.datausage.NetworkStats.IFACE_ALL;
import static com.tcl.manager.datausage.NetworkStats.SET_DEFAULT;
import static com.tcl.manager.datausage.NetworkStats.TAG_NONE;
import static com.tcl.manager.datausage.NetworkStats.UID_ALL;
import static com.tcl.manager.datausage.NetworkStatsHistory.Entry.UNKNOWN;
...
//        System.out.println("NetworkStatsHistory version:"+version);
        switch (version) {
            case VERSION_INIT: {
                bucketDuration = in.readLong();
//                System.out.println("VERSION_INIT bucketDuration:"+bucketDuration);
                
                bucketStart = DataStreamUtils.readFullLongArray(in);
//                System.out.println("VERSION_INIT bucketStart:"+ Arrays.toString(bucketStart));
                
                rxBytes = DataStreamUtils.readFullLongArray(in);
//                System.out.println("VERSION_INIT rxBytes:"+ Arrays.toString(rxBytes));
                
                rxPackets = new long[bucketStart.length];
                txBytes = DataStreamUtils.readFullLongArray(in);
//                System.out.println("VERSION_INIT txBytes:"+ Arrays.toString(txBytes));

                txPackets = new long[bucketStart.length];
                operations = new long[bucketStart.length];
                bucketCount = bucketStart.length;
                totalBytes = total(rxBytes) + total(txBytes);
//                System.out.println("VERSION_INIT totalBytes:"+ totalBytes);
                break;
            }
            case VERSION_ADD_PACKETS:
            case VERSION_ADD_ACTIVE: {
                bucketDuration = in.readLong();
//                System.out.println("VERSION_ADD bucketDuration:"+bucketDuration);
                
                bucketStart = DataStreamUtils.readVarLongArray(in);
//                System.out.println("VERSION_ADD bucketStart:"+ Arrays.toString(bucketStart));
                
                activeTime = (version >= VERSION_ADD_ACTIVE) ? DataStreamUtils.readVarLongArray(in)
                        : new long[bucketStart.length];
//                System.out.println("VERSION_ADD activeTime:"+ Arrays.toString(activeTime));
                
                rxBytes = DataStreamUtils.readVarLongArray(in);
//                System.out.println("VERSION_ADD rxBytes:"+ Arrays.toString(rxBytes));
                
                rxPackets = DataStreamUtils.readVarLongArray(in);
//                System.out.println("VERSION_ADD rxPackets:"+ Arrays.toString(rxPackets));
                
                txBytes = DataStreamUtils.readVarLongArray(in);
//                System.out.println("VERSION_ADD txBytes:"+ Arrays.toString(txBytes));
                
                txPackets = DataStreamUtils.readVarLongArray(in);
//                System.out.println("VERSION_ADD txPackets:"+ Arrays.toString(txPackets));
                
                operations = DataStreamUtils.readVarLongArray(in);
//                System.out.println("VERSION_ADD operations:"+ Arrays.toString(operations));
                
                bucketCount = bucketStart.length;
                totalBytes = total(rxBytes) + total(txBytes);
                
//                System.out.println("VERSION_ADD totalBytes:"+ totalBytes);
                break;
            }
            default: {
   ...
   /* public void writeToStream(DataOutputStream out) throws IOException {
        ...
        DataStreamUtils.writeVarLongArray(out, bucketStart, bucketCount);
        DataStreamUtils.writeVarLongArray(out, activeTime, bucketCount);
        DataStreamUtils.writeVarLongArray(out, rxBytes, bucketCount);
        DataStreamUtils.writeVarLongArray(out, rxPackets, bucketCount);
        DataStreamUtils.writeVarLongArray(out, txBytes, bucketCount);
        DataStreamUtils.writeVarLongArray(out, txPackets, bucketCount);
        DataStreamUtils.writeVarLongArray(out, operations, bucketCount);
    }*/
    ...
    public int getIndexBefore(long time) {
        ...
        return constrain(index, 0, bucketCount - 1);
    }
...
//            final long bucketEnd = bucketStart + input.bucketDuration;
            ...
            recordData(bucketStart, Long.MAX_VALUE, entry);
        }
    }
