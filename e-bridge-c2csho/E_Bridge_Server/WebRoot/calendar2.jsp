...
function display()
{
  ...
  document.write("<input style='text-align:center;border:1px solid;' id='DS_"+this.inputName+"' name='"+this.inputName+"' value='"+objyear+"-"+objmonth+"-"+objdate+"' readonly>");
  document.write("<button style='width:60px;height:18px;font-size:12px;margin:1px;border:1px solid #A4B3C8;background-color:#cccccc' type=button onclick=this.nextSibling.style.display='block' onfocus=this.blur()>选择日期</button>");
...
<!--
  var myDate=new Date();
  objyear=myDate.getYear();     
  objmonth=myDate.getMonth()+1;  
  objdate=myDate.getDate();   
  inputName='arrivetime';
  display();
//-->
</script>