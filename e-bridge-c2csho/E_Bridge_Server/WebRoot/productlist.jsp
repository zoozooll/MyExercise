			...
			<div id="main">	
				<div id="recommend" style="width:716px;">	
					...
					<c:forEach var="pro" items="${productss}">										 
						<li style="height:210px;padding:5px 1px 5px 4px;margin:5px 5px 5px 2px;"><a href="showProduct.action?proId=${pro.proId}">											
					...
					<jsp:include page="pageman.jsp"></jsp:include>	
				</div>	
			</div>
			</div>
	</body>
