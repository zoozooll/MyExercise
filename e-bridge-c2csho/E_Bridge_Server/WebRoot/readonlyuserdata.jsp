...
<html>
	...
	<div id="container" style="height: auto">
			<span style="text-align: left;">您现在所在的位置是:Today&gt;&gt;<a href="index.jsp">首页</a>&gt;&gt;<a href="findAllPurchasersAction.action">个人中心</a>&gt;&gt;<a style="color:red;font-weight: bold;">用户信息</a>&gt;&gt;</span>			
				<c:choose>
