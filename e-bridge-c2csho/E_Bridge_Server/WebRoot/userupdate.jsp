...
<BODY>
		<div id="container" style="height: auto">
			...
			<!--head--><DIV>
				...
				<form action="updatePurchaserAction.action" method="post" name="reg"
					class='required-validate'>
					<div class="stylediv">
						<ul>
							<li style="float:left; font:bolder">修改您的帐户信息 
							</li>
						</ul>
					</div>
					<div class="stylediv">
					...
					<%--<div class="stylediv">
						<ul>
							<li style="float:left; font:bolder">
								<span>&nbsp;&nbsp;公司地址:</span>
								 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="text" name="purProvince" size="15" value="${purchaser.purProvince}" class="required"/>
									
								<input type="text" name="purCity" size="15" value="${purchaser.purCity}" class="required"/>									
							</li>
						</ul>
					</div>
						--%>
					...
					<DIV style="margin-top: 20px;margin-left: -100px">
						<center><a href="updatePurchaserAction.action"><img src="images/common/modify.jpg" alt="修改信息"/></a></center>
					</DIV>
				</form>						
		</center>
						</div>
