...
-->
	...
	<body>
		<div id="container" style="height: auto;">
			<span style="text-align: left;">您现在所在的位置是:Today&gt;&gt;<a href="index.jsp">首页</a>&gt;&gt;<a style="color:red;font-weight: bold;">产品列表</a>&gt;&gt;</span>			
			<jsp:include page="indexleft.jsp"></jsp:include>
			<div id="main">	
				<div id="recommend" style="width:716px;">	
					<ul>		
					<c:forEach var="pro" items="${productss}">										 
						...
						<div align="center">
								<a href="addProductToCartAction.action?productId=${pro.proId}"><img src="images/common/cartbuy.jpg" alt="购买" style="width:auto;border: none;height:auto;"/></a>								
							</div>	
					</c:forEach>
					</ul>
					<jsp:include page="typePageman.jsp"></jsp:include>	
				</div>	
			</div>
			</div>
	</body>
