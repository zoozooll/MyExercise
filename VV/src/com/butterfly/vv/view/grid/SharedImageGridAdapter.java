...
public class SharedImageGridAdapter extends BaseAdapter {
	...
	public SharedImageGridAdapter(Activity context, List<VVImage> mItems,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = layoutInflater.inflate(R.layout.gridviewitem, parent,
					false);
