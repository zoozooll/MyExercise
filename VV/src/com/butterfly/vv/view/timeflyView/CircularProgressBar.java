...
public class CircularProgressBar extends ProgressBar {
	...
	public void init(AttributeSet attrs, int style) {
		...
		String t = a.getString(android.support.v7.appcompat.R.styleable.ActionBar_title);
		if (t != null)
			mTitle = t;
		t = a.getString(android.support.v7.appcompat.R.styleable.ActionBar_subtitle);
		if (t != null)
			mSubTitle = t;
	...
	// public void animateProgressTo(final int start, final int end, final
