...
interface IBeemRosterListener {
    ...
    void onRostersUpdate(in List<Contact> rosters);
	void onNewFriendsUpdate(in List<Contact> newfriends);
	void onBlacklistUpdate(in List<Contact> blacklist);
	void onBlacklistedUpdate(in List<String> blacklisted);
	void onUserUpdate(in String user, in Contact contact);
	void onActionResult(in String action, in boolean state);
}
