...
interface IChat {
    	 ...
    	 */
	void sendMessage(in com.beem.project.btf.service.Message message);
	...
	void setMessageState(in int msgState,in long timeMils);

	void setState(in String state);

	List<com.beem.project.btf.service.Message> getMessages();
