...
interface IMessageListener {
	 ...
	 */
	void processMessage(in IChat chat, in com.beem.project.btf.service.Message msg);
	...
	//截获发送message
	void interceptMessage(in IChat chat, in com.beem.project.btf.service.Message msg);
