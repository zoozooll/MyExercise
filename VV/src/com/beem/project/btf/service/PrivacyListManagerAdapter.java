...
import com.beem.project.btf.service.aidl.IPrivacyListListener;
...
public class PrivacyListManagerAdapter extends IPrivacyListManager.Stub {
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#blockUser(java .lang.String,
	 * java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#createPrivacyList
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager# declineActivePrivacyList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager# declineDefaultPrivacyList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#editPrivacyList (java.lang.String,
	 * java.util.List)
	 */
	@Override
	public void editPrivacyList(String listName, List<PrivacyListItem> items)
		...
		try {
			mPrivacyListManager.updatePrivacyList(listName,
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#getActivePrivacyList ()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#getBlockedGroupsByList
	 * (java.lang.String )
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#getBlockedUsersByList
	 * (java.lang.String )
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#getDefaultPrivacyList ()
	 */
	@Override
	public String getDefaultPrivacyList() throws RemoteException {
		try {
			PrivacyList defaultPrivacyList = mPrivacyListManager
					.getDefaultList();
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#removePrivacyList
	 * (java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#setActivePrivacyList
	 * (java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#setDefaultPrivacyList
	 * (java.lang.String )
	 */
	@Override
	...
	private class PrivacyListListenerAdapter implements PrivacyListListener {
		...
		public void setPrivacyList(final String listName,
			...
			while (i > 0) {
				i--;
				try {
					mPrivacyListListeners.getBroadcastItem(i).setPrivacyList(
							listName,
		...
		public void updatedPrivacyList(final String listName) {
			...
			while (i > 0) {
				i--;
				try {
					mPrivacyListListeners.getBroadcastItem(i)
	...
	/*
	 * (non-Javadoc)
	 * @see com.beem.project.btf.service.aidl.IPrivacyListManager#getPrivacyLists()
	 */
	@Override
	public List<String> getPrivacyLists() throws RemoteException {
		...
		try {
			PrivacyList[] registeredPrivacyLists = mPrivacyListManager
					.getPrivacyLists();
