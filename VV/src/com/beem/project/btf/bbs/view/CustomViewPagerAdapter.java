...
public class CustomViewPagerAdapter extends PagerAdapter {
	...
	private List<? extends View> titles;
	private Context mContext;

	public CustomViewPagerAdapter(List<? extends View> datas, Context context) {
		super();
		this.datas = datas;
		this.mContext = context;
	}
	public CustomViewPagerAdapter(Context context, List<? extends View> datas,
			List<? extends View> titles) {
		super();
		this.datas = datas;
		this.titles = titles;
		this.mContext = context;
