...
/**
 * @author sunday 2013-12-04 带删除按钮和搜索图标的edittext
 */
public class ClearEditText3 extends EditText {
	...
	public ClearEditText3(Context context) {
		super(context);
		mContext = context;
		init();
	}
	public ClearEditText3(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		mContext = context;
		init();
	}
	public ClearEditText3(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		init();
	}
	private void init() {
		imgright = mContext.getResources().getDrawable(
				R.drawable.delete_icon_selector);
		imgleft = mContext.getResources().getDrawable(
				R.drawable.serch_timeflyid_icon);
