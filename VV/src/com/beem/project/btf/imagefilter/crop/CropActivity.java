...
public class CropActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mSaveButton = findViewById(R.id.ok_image_camera);
	...
	/**
	 * Opens a selector in Gallery to chose an image for use when none was given in the CROP intent.
	 */
	private void pickImage() {
		Intent intent = new Intent();
		intent.setType("image/*");
		intent.setAction(Intent.ACTION_GET_CONTENT);
		startActivityForResult(Intent.createChooser(intent, "select_image"),
				SELECT_PICTURE);
	}
	/**
	...
	private void startLoadBitmap(Uri uri) {
		if (uri != null) {
			...
			mLoadBitmapTask = new LoadBitmapTask(rotate);
	...
	private void cannotLoadImage() {
		CharSequence text = "cannot_load_image";
	...
	private class LoadBitmapTask extends AsyncTask<Uri, Void, Bitmap> {
		...
		public LoadBitmapTask(int orientation) {
	...
	private void startBitmapIO(int flags, Bitmap currentBitmap, Uri sourceUri,
		...
		if ((flags & DO_SET_WALLPAPER) != 0) {
			Toast.makeText(this, "setting_wallpaper", Toast.LENGTH_LONG).show();
		}
		final View loading = findViewById(R.id.loading);
		loading.setVisibility(View.VISIBLE);
	...
	protected static String getFileExtension(String requestFormat) {
		...
		return (outputFormat.equals("png") || outputFormat.equals("gif")) ? "png" // We don't support gif compression.
				: "jpg";
	}
	...
	/**
	 * Returns the bitmap from the given uri loaded using the given options. Returns null on
	 * failure.
	 */
