...
public class CropMath {
	...
	/**
	 * Takes a point and the corners of a rectangle and returns the two corners representing the
	 * side of the rectangle closest to the point.
	...
	/**
	 * Resizes rectangle to have a certain aspect ratio (center remains stationary) while
	 * constraining it to remain within the original rect.
	 * @param r rectangle to resize
	 * @param w new width aspect
	 * @param h new height aspect
	 */
