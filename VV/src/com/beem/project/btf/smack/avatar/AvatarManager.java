...
import com.beem.project.btf.smack.pep.PEPListener;
...
/**
 * This class deals with the avatar data. It can be configured to auto retrieve the avatar and put
 * it in cache.
 */
public class AvatarManager {
	...
	/**
	 * Send the metadata of the avatar you want to publish. By sending this metadata, you publish an
	 * avatar.
	...
	/**
	 * Select the avatar to download. Subclass should override this method to take control over the
	 * selection process. This implementation select the first element.
