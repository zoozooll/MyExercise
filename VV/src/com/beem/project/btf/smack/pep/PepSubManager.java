 ...
 */
package com.beem.project.btf.smack.pep;
...
public class PepSubManager extends PubSubManager {
	...
	private PacketFilter mPacketFilter = new PacketExtensionFilter("event",
	...
	/**
	 * Create a PepSubManager associated to the specified connection where the pubsub requests
	...
	/**
	 * Get a PepNode. This node is obtain without checking its existence as PEP should auto create
	 * it.
	...
	private void init(Connection con) {
		PacketListener packetListener = new PacketListener() {
			...
			public void processPacket(Packet packet) {
				EventElement e = (EventElement) packet.getExtension("event",
						"http://jabber.org/protocol/pubsub#event");
