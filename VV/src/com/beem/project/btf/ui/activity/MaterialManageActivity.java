...
public class MaterialManageActivity extends FragmentActivity {
	...
	public static void launch(Context context, IMaterialType materialType) {
		Intent intent = new Intent(context, MaterialManageActivity.class);
	...
	private void InitViewPager() {
		...
		for (IMaterialType dt : materialType.getAllMembers()) {
			Fragment tempFragment = dt.getFragment(ActivityType.Manage);
