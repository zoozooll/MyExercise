...
public class CommonViewHolder {
	...
	public CommonViewHolder(SparseArray<View> views, View convertView,
	...
	public <T extends View> T getView(int id) {
		...
		if (holder == null) {
			throw new IllegalStateException(
					"you must call the getViewHolder first");
		}
	...
	public static CommonViewHolder getViewHolder(int position,
		...
		if (convertView == null) {
			...
			holder = new CommonViewHolder(new SparseArray<View>(), convertView,
					parent, position);
						...
						if (position > 0 && position % 2 == 1) {
							...
							if (height > lastheight) {
								...
								v.setLayoutParams(new AbsListView.LayoutParams(
										LayoutParams.WRAP_CONTENT, lastheight));
							}
						}
					}
				});
