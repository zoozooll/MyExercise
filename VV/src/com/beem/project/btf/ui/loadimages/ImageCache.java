...
public class ImageCache {
	...
	public static class ImageCacheParams {
		 ...
		 * Throws {@link IllegalArgumentException} if percent is < 0.01 or > .8. memCacheSize is
		...
		public void setMemCacheSize(int kb) {
			memCacheSize = kb;
		}
	}
	...
	private static boolean canUseForInBitmap(Bitmap candidate,
		...
		/*
		 * int width = targetOptions.outWidth / targetOptions.inSampleSize; int height =
		 * targetOptions.outHeight / targetOptions.inSampleSize; int byteCount = width * height *
		 * getBytesPerPixel(candidate.getConfig()); return byteCount <=
	...
	public static int getBitmapSize(BitmapDrawable value) {
		...
		/*
		 * if (Build.VERSION.SDK_INT >= 19) { return bitmap.getAllocationByteCount(); }
		 */
