 ...
 */
package com.beem.project.btf.ui.views.wheelviewWidget;
...
import com.beem.project.btf.ui.views.wheelviewWidget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	/*
	 * / Modified by wulianghuan 2014-11-25 private int[] SHADOWS_COLORS = new int[] { 0xFF111111,
	 * 0x00AAAAAA, 0x00AAAAAA }; //
	 */
	private int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF, 0x99FFFFFF,
			0x00FFFFFF };
	...
	private void drawCenterRect(Canvas canvas) {
		...
		/*
		 * / Remarked by wulianghuan 2014-11-27 使用自己的画线，而不是描边 Rect rect = new Rect(left, top, right,
		 * bottom) centerDrawable.setBounds(bounds) centerDrawable.setBounds(0, center - offset,
		 * getWidth(), center + offset); centerDrawable.draw(canvas); //
		 */
		Paint paint = new Paint();
		paint.setColor(0xff1aaef1);
		// 设置线宽
