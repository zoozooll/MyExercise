 ...
 */
public class SharerankingAnimatableTopView {
	/* ******初始化状态的值，即动画未开始，或者回到初始化状态后的值,单位px****** */
	private int maxHeight;
	private int firstTopbtnMarginTop;
	private int firstTopbtnMarginHorizontal;
	private int firstTopbtnWidth;
	...
	public void initialize(View root) {
		...
		firstTopbtnMarginTop = back.getTop();
		firstTopbtnMarginHorizontal = back.getLeft();
		firstTopbtnWidth = back.getWidth();
