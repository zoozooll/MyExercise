 ...
 */
public class SchoolVCard extends IQ {
	/**
	...
	private void doLoad(Connection connection, String user)
		...
		PacketCollector collector = connection
				.createPacketCollector(new PacketIDFilter(getPacketID()));
		connection.sendPacket(this);
		SchoolVCard result = null;
		try {
			result = (SchoolVCard) collector.nextResult(SmackConfiguration
					.getPacketReplyTimeout());
			if (result == null) {
	...
	private void copyFieldsFrom(SchoolVCard result) {
		if (result == null)
			result = new SchoolVCard();
		Field[] fields = SchoolVCard.class.getDeclaredFields();
		for (Field field : fields) {
			if (field.getDeclaringClass() == SchoolVCard.class
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		final SchoolVCard vCard = (SchoolVCard) o;
	...
	private class VCardWriter {
		...
		public void write() {
			appendTag("vCard", "xmlns", "school", hasContent(),
					new ContentBuilder() {
						@Override
