 ...
 * about it's registration support. SET queries can be used to create accounts or update existing
 * account information. XMPP servers may require a number of attributes to be set when creating a
 * new account. The standard account attributes are as follows:
 * <ul>
...
public class Registration extends IQ {
	...
	/**
	 * Returns the registration instructions, or <tt>null</tt> if no instructions have been set. If
	 * present, instructions should be displayed to the end-user that will complete the registration
	 * process.
