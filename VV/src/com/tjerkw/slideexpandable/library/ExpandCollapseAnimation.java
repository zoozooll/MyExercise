...
/**
 * Animation that either expands or collapses a view by sliding it down to make it visible. Or by
 * sliding it up so it will hide. It will look like it slides behind the view above.
 * @auther tjerk
 * @date 6/9/12 4:58 PM
 */
