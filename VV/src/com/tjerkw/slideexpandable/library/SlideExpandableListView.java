...
/**
 * Simple subclass of listview which does nothing more than wrap any ListAdapter in a
 * SlideExpandalbeListAdapter
 */
public class SlideExpandableListView extends ListView {
	...
	/**
	 * Registers a OnItemClickListener for this listview which will expand the item by default. Any
	 * other OnItemClickListener will be overriden. To undo call setOnItemClickListener(null)
