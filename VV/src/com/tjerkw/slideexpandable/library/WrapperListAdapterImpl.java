...
/**
 * Implementation of a WrapperListAdapter interface in which method delegates to the wrapped
 * adapter. Extend this class if you only want to change a few methods of the wrapped adapter. The
 * wrapped adapter is available to subclasses as the "wrapped" field.
 * @author tjerk
 * @date 6/9/12 4:41 PM
 */
