...
public class PullGridView extends GridViewWithHeaderAndFooter {
	private final PullToRefreshBase base;
	...
	public PullGridView(Context context, PullToRefreshBase base) {
		super(context);
		this.base = base;
	...
	public boolean isFillScreenItem() {
		...
		if (visibleItemCount < totalItemCount || (getScrollY() > 0)) {
				...
				observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						base.getFooterLoadingLayout().show(
								base.isPullLoadEnabled() && isFillScreenItem());
