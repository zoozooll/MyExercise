...
/**
 * Request ID sequence generator. This generator generates a random first RID and then manages the
 * sequence from there on out.
 */
final class RequestIDSequence {
	/**
	 * Maximum number of bits available for representing request IDs, according to the XEP-0124
	 * spec.s
	 */
	...
	// Public methods:
	/**
	 * Calculates the next request ID value to use. This number must be initialized such that it is
	 * unlikely to ever exceed 2 ^ 53, according to XEP-0124.
	...
	// Private methods:
	/**
	 * Generates an initial RID value by generating numbers until a number is found which is smaller
	 * than the maximum allowed value and greater than zero.
