...
/**
 * Qualified name of an attribute of the wrapper element. This class is analagous to the
 * {@code javax.xml.namespace.QName} class. Each qualified name consists of a namespace URI and a
 * local name.
 * <p/>
...
public final class BodyQName {
	...
	/**
	 * Creates a new qualified name using a namespace URI and local name along with an optional
	 * prefix.
	 * @param uri namespace URI
	 * @param local local name
	...
	/**
	 * Get the optional prefix used with this qualified name, or {@code null} if no prefix has been
	 * assiciated.
