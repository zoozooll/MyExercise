...
/**
 * Class containing constants for attribute definitions used by the XEP-0124 specification. We
 * shouldn't need to expose these outside our package, since nobody else should be needing to worry
 * about them.
 */
