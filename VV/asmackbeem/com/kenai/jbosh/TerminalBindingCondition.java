...
final class TerminalBindingCondition {
	 ...
	 * @return terminal binding condition instance, or {@code null} if no instance is known by the
	 *         name specified
	 */
	...
	/**
	 * Lookup the terminal binding condition instance associated with the HTTP response code
	 * specified.
