...
/**
 * A request and response pair representing a single exchange with a remote content manager. This is
 * primarily a container class intended to maintain the relationship between the request and
 * response but allows the response to be added after the fact.
 */
