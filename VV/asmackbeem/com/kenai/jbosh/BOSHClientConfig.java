...
/**
 * BOSH client configuration information. Instances of this class contain all information necessary
 * to establish connectivity with a remote connection manager.
 * <p/>
...
public final class BOSHClientConfig {
	...
	// Classes:
	/**
	 * Class instance builder, after the builder pattern. This allows each {@code BOSHClientConfig}
	 * instance to be immutable while providing flexibility when building new
	 * {@code BOSHClientConfig} instances.
	 * <p/>
	 * Instances of this class are <b>not</b> thread-safe. If template-style use is desired, see the
	 * {@code create(BOSHClientConfig)} method.
	 */
	public static final class Builder {
		...
		/**
		 * Creates a new builder instance, used to create instances of the {@code BOSHClientConfig}
		 * class.
		...
		/**
		 * Creates a new builder instance using the existing configuration provided as a starting
		 * point.
		...
		/**
		 * Set the ID of the client station, to be forwarded to the connection manager when new
		...
		/**
		 * Sets the destination server/domain that the client should connect to. Connection managers
		 * may be configured to enable sessions with more that one server in different domains. When
		 * requesting a session with such a "proxy" connection manager, a client should use this
		 * method to specify the server with which it wants to communicate.
		 * @param protocol connection protocol (e.g, "xmpp")
		 * @param host host or domain to be served by the remote server. Note that this is not
		 *            necessarily the host name or domain name of the remote server.
		...
		/**
		 * Set the SSL context to use for this session. This can be used to configure
		...
		/**
		 * Set whether or not compression of the underlying data stream should be attempted. By
		 * default, compression is disabled.
		 * @param enabled set to {@code true} if compression should be attempted when possible,
		 *            {@code false} to disable compression
		 * @return builder instance
		 */
	...
	/**
	 * Determines whether or not compression of the underlying data stream should be
	 * attempted/allowed. Defaults to {@code false}.
	 * @return {@code true} if compression should be attempted, {@code false} if compression is
	 *         disabled or was not specified
	 */
