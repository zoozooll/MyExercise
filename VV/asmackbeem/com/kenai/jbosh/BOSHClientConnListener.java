...
public interface BOSHClientConnListener {
	/**
	 * Called when the connection state of the client which the listener is registered against has
	 * changed. The event object supplied can be used to determine the current session state.
