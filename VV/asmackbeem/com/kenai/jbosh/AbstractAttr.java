...
/**
 * Abstract base class for creating BOSH attribute classes. Concrete implementations of this class
 * will naturally inherit the underlying type's behavior for {@code equals()}, {@code hashCode()},
 * {@code toString()}, and {@code compareTo()}, allowing for the easy creation of objects which
 * extend existing trivial types. This was done to comply with the prefactoring rule declaring,
