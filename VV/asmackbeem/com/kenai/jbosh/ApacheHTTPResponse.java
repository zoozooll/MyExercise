...
final class ApacheHTTPResponse implements HTTPResponse {
	...
	/**
	 * Exception to throw when the response data is attempted to be accessed, or {@code null} if no
	 * exception should be thrown.
	 */
	private BOSHException toThrow;
	/**
	 * The response body which was received from the server or {@code null} if that has not yet
	 * happened.
	 */
	...
	// Constructors:
	/**
	 * Create and send a new request to the upstream connection manager, providing deferred access
	 * to the results to be returned.
	 * @param client client instance to use when sending the request
	 * @param cfg client configuration
	 * @param params connection manager parameters from the session creation response, or
	 *            {@code null} if the session has not yet been established
	...
	/**
	 * Await the response, storing the result in the instance variables of this class when they
	 * arrive.
	 * @throws InterruptedException if interrupted while awaiting the response
	 * @throws BOSHException on communication failure
	 */
