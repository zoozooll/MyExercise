...
/**
 * Implementation of the BodyParser interface which uses the XmlPullParser API. When available, this
 * API provides an order of magnitude performance improvement over the default SAX parser
 * implementation.
 */
final class BodyParserXmlPull implements BodyParser {
	 ...
	 * This allows us to gain an order of magnitude of performance as a result of not constructing
