...
class DigestChallenge extends Object {
	...
	/**
	 * Checks the semantics of the directives in the directive list as parsed from the digest
	 ...
	 * @exception SaslException If an error occurs due to too many nonce values
	 */
...
/**
	...
	/**
	 * This function implements the semenatics of the Maxbuf directive. the value is defined as:
	 * 1*DIGIT
	 * @param pd ParsedDirective
	...
	/**
	 * This function implements the semenatics of the charset directive. the value is defined as:
	 * 1*DIGIT
	 * @param pd ParsedDirective
	 * @exception SaslException If an error occurs dur to too many charset directives or Invalid
	 ...
	 * 1*DIGIT
	 * @param pd ParsedDirective
	 * @exception SaslException If an error occurs due to too many algorith directive or Invalid
	 *                algorithm directive value
	 */
...
/**
	 ...
	 * @param pd ParsedDirective
	 * @exception SaslException If an error occurs due to Too many stale directives or Invalid stale
	 *                directive value
	 */
