...
public abstract class Configuration {
	...
	/**
	 * Reads name of default configuration provider from security.properties, loads the class and
	 * instantiates the provider.<br>
	 * In case of any exception, wraps it with SecurityException and throws further.
	 */
	...
	/**
	 * Shortcut accessor for friendly classes, to skip security checks. If active configuration was
	 * set to <code>null</code>, tries to load a default provider, so this method never returns
	 * <code>null</code>. <br>
