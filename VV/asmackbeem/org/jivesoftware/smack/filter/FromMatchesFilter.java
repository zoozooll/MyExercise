 ...
 * address is a bare JID then the filter will match any address whose bare JID matches the specified
 * JID. But if the specified address is a full JID then the filter will only match if the sender of
 * the packet matches the specified resource.
