...
/**
 * Implements the logical AND operation over two or more packet filters. In other words, packets
...
public class AndFilter implements PacketFilter {
	...
	/**
	 * Adds a filter to the filter list for the AND operation. A packet will pass the filter if all
