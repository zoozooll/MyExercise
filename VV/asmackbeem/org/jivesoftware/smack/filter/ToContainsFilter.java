...
/**
 * Filters for packets where the "to" field contains a specified value. For example, the filter
 * could be used to listen for all packets sent to a group chat nickname.
 * @author Matt Tucker
 */
