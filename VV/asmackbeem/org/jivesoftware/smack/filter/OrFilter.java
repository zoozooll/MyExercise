...
/**
 * Implements the logical OR operation over two or more packet filters. In other words, packets pass
 * this filter if they pass <b>any</b> of the filters.
 * @author Matt Tucker
 */
public class OrFilter implements PacketFilter {
	...
	/**
	 * Adds a filter to the filter list for the OR operation. A packet will pass the filter if any
