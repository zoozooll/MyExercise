 ...
 * </ul>
 * Subclasses will likely want to implement their own versions of these mthods: <li>
 * {@link #authenticate(String, String, String)} -- Initiate authentication stanza using the
 * deprecated method.</li> <li>
 * {@link #authenticate(String, String, CallbackHandler)} -- Initiate
 * authentication stanza using the CallbackHandler method.</li> <li>
 * {@link #challengeReceived(String)} -- Handle a challenge from the server.</li> </ul>
 * @author Jay Kline
 */
