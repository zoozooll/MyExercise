...
public class PrivacyListManager {
	...
	/**
	 * Creates a new privacy manager to maintain the communication privacy. Note: no information is
	 * sent to or received from the server until you attempt to get or set the privacy
	 * communication.
	 * <p>
	...
	/**
	 * The client has edited an existing list. It updates the server content with the resulting list
	 * of privacy items. The {@link PrivacyItem} list MUST contain all elements in the list (not the
	 * "delta").
	 * @param listName the list that has changed its content.
	 * @param privacyItems a List with every privacy item in the list.
	 * @throws XMPPException if an error occurs.
	...
	/**
	 * Adds a packet listener that will be notified of any new update in the user privacy
	 * communication.
