...
/**
 * A generic exception that is thrown when an error occurs performing an XMPP operation. XMPP
 * servers can respond to error conditions with an error code and textual description of the
 * problem, which are encapsulated in the XMPPError class. When appropriate, an XMPPError instance
 * is attached instances of this exception.
 * <p>
 * When a stream error occured, the server will send a stream error to the client before closing the
 * connection. Stream errors are unrecoverable errors. When a stream error is sent to the client an
 * XMPPException will be thrown containing the StreamError sent by the server.
 * @see XMPPError
 * @author Matt Tucker
 */
public class XMPPException extends Exception {
	 ...
	 * When a stream error is received from the server then the underlying TCP connection will be
	...
	/**
	 * Creates a new XMPPException with a description of the exception and the Throwable that was
	...
	/**
	 * Creates a new XMPPException with a description of the exception and the XMPPException that
	 * was the root cause of the exception.
	 * @param message a description of the exception.
	 * @param error the root cause of the exception.
	 */
	public XMPPException(String message, XMPPError error) {
	...
	/**
	 * Returns the XMPPError asscociated with this exception, or <tt>null</tt> if there isn't one.
	...
	/**
	 * Returns the StreamError asscociated with this exception, or <tt>null</tt> if there isn't one.
	 * The underlying TCP connection is closed by the server after sending the stream error to the
	 * client.
	...
	/**
	 * Returns the Throwable asscociated with this exception, or <tt>null</tt> if there isn't one.
