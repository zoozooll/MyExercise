...
/**
 * A Privacy IQ Packet, is used by the {@link org.jivesoftware.smack.PrivacyListManager} and
 * {@link org.jivesoftware.smack.provider.PrivacyProvider} to allow and block communications from
 * other users. It contains the appropriate structure to suit user-defined privacy lists. Different
 * configured Privacy packages are used in the server & manager communication in order to:
 * <ul>
...
public class Privacy extends IQ {
	...
	/**
	 * itemLists holds the set of privacy items classified in lists. It is a map where the key is
	 * the name of the list and the value a collection with privacy items.
	 **/
	...
	/**
	 * Deletes an existing privacy list. If the privacy list being deleted was the default list then
	 * the user will end up with no default list. Therefore, the user will have to set a new default
	 * list.
	...
	/**
	 * Returns the name associated with the active list set for the session. Communications will be
	 * verified against the active list.
	...
	/**
	 * Sets the name associated with the active list set for the session. Communications will be
	 * verified against the active list.
	 ...
	 * processed if there is no active list set for the target session/resource to which a stanza is
	 * addressed, or if there are no current sessions for the user.
	 ...
	 * processed if there is no active list set for the target session/resource to which a stanza is
	 * addressed, or if there are no current sessions for the user. If there is no default list set,
	 * then all Privacy Items are processed.
	 ...
	 * rules that define if communication with the list owner is allowed or denied. Users may have
	 * zero, one or more privacy items.
	 * @return a map where the key is the name of the list and the value the collection of privacy
	 *         items.
	 */
