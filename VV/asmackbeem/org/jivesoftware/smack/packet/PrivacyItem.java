...
public class PrivacyItem {
	 ...
	 * identifier to apply the action. If the type is "jid", then the 'value' attribute MUST contain
	 * a valid Jabber ID. If the type is "group", then the 'value' attribute SHOULD contain the name
	 * of a group in the user's roster. If the type is "subscription", then the 'value' attribute
	 * MUST be one of "both", "to", "from", or "none".
	 */
	...
	/**
	 * Returns the action associated with the item, it MUST be filled and will allow or deny the
	 * communication.
	 ...
	 * @param filterPresence_in indicates if the receiver allows or denies filtering incoming
	 *            presence.
	 */
	 ...
	 * @param filterPresence_out indicates if the receiver allows or denies filtering outgoing
	 *            presence
	 */
	...
	/**
	 * Returns the order where the receiver is processed. List items are processed in ascending
	 * order. The order MUST be filled and its value MUST be a non-negative integer that is unique
	...
	/**
	 * Sets the order where the receiver is processed. The order MUST be filled and its value MUST
	 * be a non-negative integer that is unique among all items in the list.
	...
	/**
	 * Sets the element identifier to apply the action. If the type is "jid", then the 'value'
	 * attribute MUST contain a valid Jabber ID. If the type is "group", then the 'value' attribute
	 * SHOULD contain the name of a group in the user's roster. If the type is "subscription", then
	...
	/**
	 * Returns the type hold the kind of communication it will allow or block. It MUST be filled
	 * with one of these values: jid, group or subscription.
	...
	/**
	 * Returns the element identifier to apply the action. If the type is "jid", then the 'value'
	 * attribute MUST contain a valid Jabber ID. If the type is "group", then the 'value' attribute
	 * SHOULD contain the name of a group in the user's roster. If the type is "subscription", then
	 * the 'value' attribute MUST be one of "both", "to", "from", or "none".
	...
	/**
	 * Returns whether the receiver allows or denies every kind of communication. When filterIQ,
	 * filterMessage, filterPresence_in and filterPresence_out are not set the receiver will block
	 * all communications.
	...
	/**
	 * Privacy Rule represents the kind of action to apply. It holds the kind of communication
	 * ([jid|group|subscription]) it will allow or block and identifier to apply the action.
	 */
	public static class PrivacyRule {
		...
		/**
		 * Returns the element identifier to apply the action. If the type is "jid", then the
		 * 'value' attribute MUST contain a valid Jabber ID. If the type is "group", then the
		 * 'value' attribute SHOULD contain the name of a group in the user's roster. If the type is
		 * "subscription", then the 'value' attribute MUST be one of "both", "to", "from", or
		 * "none".
		...
		/**
		 * Sets the element identifier to apply the action. If the type is "jid", then the 'value'
		 * attribute MUST contain a valid Jabber ID. If the type is "group", then the 'value'
		 * attribute SHOULD contain the name of a group in the user's roster. If the type is
		 * "subscription", then the 'value' attribute MUST be one of "both", "to", "from", or
		 * "none".
		 * @param value is the identifier to apply the action.
		 */
		...
		/**
		 * Sets the element identifier to apply the action. The 'value' attribute MUST be one of
		 * "both", "to", "from", or "none".
		 * @param value is the identifier to apply the action.
		 */
