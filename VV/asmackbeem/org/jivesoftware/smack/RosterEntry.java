...
public class RosterEntry {
	...
	RosterEntry(String user, String name, RosterPacket.ItemType type,
			RosterPacket.ItemStatus status, String getOnlineTime,
			String getPhoto, String getNote, String getBday, String getRole,
	 ...
	 * RosterPacket.ItemType.none or RosterPacket.ItemType.from, refer to {@link RosterEntry
	 * getStatus()} to see if a subscription request is pending.
	 * @return the type.
	 */
