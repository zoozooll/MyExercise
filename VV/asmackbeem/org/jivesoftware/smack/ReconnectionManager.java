...
/**
 * Handles the automatic reconnection process. Every time a connection is dropped without the
 * application explictly closing it, the manager automatically tries to reconnect to the server.
 * <p>
...
public class ReconnectionManager implements ConnectionListener {
	...
	/**
	 * Starts a reconnection mechanism if it was configured to do that. The algorithm is been
	 * executed when the first connection error is detected.
	 * <p/>
