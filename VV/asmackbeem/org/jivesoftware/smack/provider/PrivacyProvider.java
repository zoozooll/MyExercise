...
/**
 * The PrivacyProvider parses {@link Privacy} packets. {@link Privacy} Parses the <tt>query</tt>
 * sub-document and creates an instance of {@link Privacy}. For each <tt>item</tt> in the
 * <tt>list</tt> element, it creates an instance of {@link PrivacyItem} and
...
public class PrivacyProvider implements IQProvider {
	...
	public IQ parseIQ(XmlPullParser parser) throws Exception {
		...
		/*
		 * privacy.addExtension(PacketParserUtils.parsePacketExtension(parser .getName(),
