...
public interface RosterStorage {
	...
	/**
	 * This methos returns the version number as specified by the "ver" attribute of the local
	 * store. Should return an emtpy string if store is empty.
	 * @return local roster version
	 */
	public String getRosterVersion();
	/**
	 * This method stores a new RosterEntry in this store or overrides an existing one. If ver is
	 * null an IllegalArgumentException should be thrown.
