...
public class RosterGroup {
	...
	/**
	 * Sets the name of the group. Changing the group's name is like moving all the group entries of
	 * the group to a new group specified by the new name. Since this group won't have entries it
	 * will be removed from the roster. This means that all the references to this object will be
	 * invalid and will need to be updated to the new group specified by the new name.
	 * @param name the name of the group.
	 */
	...
	/**
	 * Adds a roster entry to this group. If the entry was unfiled then it will be removed from the
	 * unfiled list and will be added to this group. Note that this is an asynchronous call -- Smack
	 * must wait for the server to receive the updated roster.
	 * @param entry a roster entry.
	...
	/**
	 * Removes a roster entry from this group. If the entry does not belong to any other group then
	 * it will be considered as unfiled, therefore it will be added to the list of unfiled entries.
	 * Note that this is an asynchronous call -- Smack must wait for the server to receive the
	 * updated roster.
	 * @param entry a roster entry.
