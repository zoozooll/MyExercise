...
/**
 * A listener that is fired anytime a message event notification is received. Message event
 * notifications are received as a consequence of the request to receive notifications when sending
 * a message.
