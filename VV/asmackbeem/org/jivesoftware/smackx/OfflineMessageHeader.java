...
/**
 * The OfflineMessageHeader holds header information of an offline message. The header information
 * was retrieved using the {@link OfflineMessageManager} class.
 * <p>
...
public class OfflineMessageHeader {
	...
	private String jid;
	/**
	 * Stamp that uniquely identifies the offline message. This stamp will be used for getting the
	 * specific message or delete it. The stamp may be of the form UTC timestamps but it is not
	...
	/**
	 * Returns the stamp that uniquely identifies the offline message. This stamp will be used for
	 * getting the specific message or delete it. The stamp may be of the form UTC timestamps but it
	 * is not required to have that format.
