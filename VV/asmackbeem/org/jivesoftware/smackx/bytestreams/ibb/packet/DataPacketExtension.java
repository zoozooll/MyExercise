...
public class DataPacketExtension implements PacketExtension {
	 ...
	 * <p>
	 * The encoded data is invalid if it contains bad Base64 input characters or if it contains the
	 * pad ('=') character on a position other than the last character(s) of the data. See <a
	 * href="http://xmpp.org/extensions/xep-0047.html#sec">XEP-0047</a> Section 6.
