 ...
 * <p>
 * If a close request is received it looks if a stored In-Band Bytestream session exists and closes
 * it. If no session with the given session ID exists an &lt;item-not-found/&gt; error is returned
 * to the sender.
