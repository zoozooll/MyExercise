 ...
 * Conferences are provided. </p> It should be noted that some extensions have been made to the JEP.
 * There is an attribute on URLs that marks a url as a news feed and also a sub-element can be added
 * to either a URL or conference indicated that it is shared amongst all users on a server.
...
public class BookmarkManager {
	 ...
	 * @return Returns the <i>BookmarkManager</i> for a connection, if it doesn't exist it is
	 *         created.
	 ...
	 * @throws XMPPException thrown when there is an issue retrieving the current bookmarks from the
	 *             server.
	 */
