...
/**
 * Represents a roster item, which consists of a JID and , their name and the groups the roster item
 * belongs to. This roster item does not belong to the local roster. Therefore, it does not persist
 * in the server.
 * <p>
