 ...
 * <p>
 * Important note: This functionality is not part of the XMPP spec and it will only work with
 * Wildfire.
 * @author Gaston Dombiak
 */
public class SharedGroupManager {
	/**
	 * Returns the collection that will contain the name of the shared groups where the user logged
	 * in with the specified session belongs.
