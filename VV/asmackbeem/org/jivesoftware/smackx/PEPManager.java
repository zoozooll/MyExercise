...
/**
 * Manages Personal Event Publishing (XEP-163). A PEPManager provides a high level access to pubsub
 * personal events. It also provides an easy way to hook up custom logic when events are received
 * from another XMPP client through PEPListeners. Use example:
 * 
 * <pre>
...
public class PEPManager {
	...
	/**
	 * Adds a listener to PEPs. The listener will be fired anytime PEP events are received from
	 * remote XMPP clients.
