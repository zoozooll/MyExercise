...
/**
 * Manages Roster exchanges. A RosterExchangeManager provides a high level access to send rosters,
 * roster groups and roster entries to XMPP clients. It also provides an easy way to hook up custom
 * logic when entries are received from another XMPP client through RosterExchangeListeners.
...
public class RosterExchangeManager {
	...
	/**
	 * Adds a listener to roster exchanges. The listener will be fired anytime roster entries are
	 * received from remote XMPP clients.
