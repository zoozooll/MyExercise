 ...
 * <p>
 * This class automatically sends a delivered notification to the sender of the message if the
 * sender has requested to be notified when the message is delivered.
