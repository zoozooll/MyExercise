...
public class EntityCapsManager {
	 ...
	 * user@server/resource (resource is required) In case of link-local connection the key is
	 * formed as user@host (no resource) In case of a server or component the key is formed as
	 * domain
	 */
	...
	/**
	 * Add a record telling what entity caps node a user has. The entity caps node has the format
	 * node#ver.
