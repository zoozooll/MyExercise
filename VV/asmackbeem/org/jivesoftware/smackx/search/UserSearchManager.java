...
/**
 * The UserSearchManager is a facade built upon Jabber Search Services (JEP-055) to allow for
 * searching repositories on a Jabber Server. This implementation allows for transparency of
 * implementation of searching (DataForms or No DataForms), but allows the user to simply use the
 * DataForm model for both types of support.
 * 
 * <pre>
...
public class UserSearchManager {
	...
	/**
	 * Submits a search form to the server and returns the resulting information in the form of
	 * <code>ReportedData</code>
