...
/**
 * Handles chat state for all chats on a particular Connection. This class manages both the packet
 * extensions and the disco response neccesary for compliance with <a
 * href="http://www.xmpp.org/extensions/xep-0085.html">XEP-0085</a>. NOTE:
...
public class ChatStateManager {
	...
	/**
	 * Returns the ChatStateManager related to the Connection and it will create one if it does not
	 * yet exist.
