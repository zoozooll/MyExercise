...
/**
 * Represents a field of a form. The field could be used to represent a question to complete, a
 * completed question or a data returned from a search. The exact interpretation of the field
...
public class FormField {
	...
	/**
	 * Creates a new FormField with the variable name that uniquely identifies the field in the
	 * context of the form.
	...
	/**
	 * Returns the label of the question which should give enough information to the user to fill
	 * out the form.
	 ...
	 * <li>text-private -> instead of showing the user what they typed, you show ***** to protect it
	 ...
	 * <li>fixed -> fixed for putting in text to show sections, or just advertise your web site in
	 * the middle of the form
	 * <li>hidden -> is not given to the user at all, but returned with the questionnaire
	 * <li>jid-single -> Jabber ID - choosing a JID from your roster, and entering one based on the
	 * rules for a JID.
	...
	/**
	 * Returns an Iterator for the default values of the question if the question is part of a form
	 * to fill out. Otherwise, returns an Iterator for the answered values of the question.
	...
	/**
	 * Sets the label of the question which should give enough information to the user to fill out
	 * the form.
