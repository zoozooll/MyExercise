...
/**
 * A MultipleRecipientManager allows to send packets to multiple recipients by making use of <a
 * href="http://www.jabber.org/jeps/jep-0033.html">JEP-33: Extended Stanza Addressing</a>. It also
 * allows to send replies to packets that were sent to multiple recipients.
 * @author Gaston Dombiak
 */
public class MultipleRecipientManager {
	/**
	 * Create a cache to hold the 100 most recently accessed elements for a period of 24 hours.
	 */
	 ...
	 *            exists.
	 * @throws XMPPException if server does not support JEP-33: Extended Stanza Addressing and some
	 *             JEP-33 specific features were requested.
	 */
	...
	/**
	 * Returns the {@link MultipleRecipientInfo} contained in the specified packet or <tt>null</tt>
	 * if none was found. Only packets sent to multiple recipients will contain such information.
	 * @param packet the packet to check.
	 * @return the MultipleRecipientInfo contained in the specified packet or <tt>null</tt> if none
	 *         was found.
	 */
	 ...
	 * attempt will be tried on the server items. The discovered information is going to be cached
	 * for 24 hours.
	...
	/**
	 * Packet that holds the XML stanza to send. This class is useful when the same packet is needed
	 * to be sent to different recipients. Since using the same packet is not possible (i.e. cannot
	 * change the TO address of a queues packet to be sent) then this class was created to keep the
	 * XML stanza to send.
	 */
