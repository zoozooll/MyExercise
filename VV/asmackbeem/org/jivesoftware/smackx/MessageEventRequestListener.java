...
/**
 * A listener that is fired anytime a message event request is received. Message event requests are
 * received when the received message includes an extension like this:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * In this example you can see that the sender of the message requests to be notified when the user
 * couldn't receive the message because he/she is offline, the message was delivered or when the
