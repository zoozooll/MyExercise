...
/**
 * A listener that is fired anytime a participant's status in a room is changed, such as the user
...
public interface ParticipantStatusListener {
	...
	/**
	 * Called when a moderator revokes voice from a participant. This means that the participant in
	 * the room was able to speak and now is a visitor that can't send messages to the room
	 * occupants.
	...
	/**
	 * Called when an administrator revokes a user membership to the room. This means that the user
	 ...
	 * user will no longer be able to kick users, grant and revoke voice, invite other users, modify
	...
	/**
	 * Called when an owner grants a user ownership on the room. This means that the user will be
	...
	/**
	 * Called when an owner revokes a user ownership on the room. This means that the user will no
	 * longer be able to change defining room features as well as perform all administrative
	 * functions.
	...
	/**
	 * Called when an owner grants administrator privileges to a user. This means that the user will
