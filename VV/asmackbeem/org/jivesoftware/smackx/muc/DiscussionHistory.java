...
/**
 * The DiscussionHistory class controls the number of characters or messages to receive when
 * entering a room. The room will decide the amount of history to return if you don't specify a
 * DiscussionHistory while joining a room.
 * <p>
 ...
 * history.
 * <li>since -> only the messages received since the datetime specified will be included in the
 * history.
 * </ul>
...
public class DiscussionHistory {
	...
	/**
	 * Sets the number of seconds to use to filter the messages received during that time. In other
	 * words, only the messages received in the last "X" seconds will be included in the history.
	 * @param seconds the number of seconds to use to filter the messages received during that time.
	 */
	public void setSeconds(int seconds) {
		this.seconds = seconds;
	}
	/**
	 * Sets the since date to use to filter the messages received during that time. In other words,
	 * only the messages received since the datetime specified will be included in the history.
