...
public class Affiliate {
	...
	/**
	 * Returns the current role of the affiliated user if the user is currently in the room. If the
	 * user is not present in the room then the answer will be null.
	 * @return the current role of the affiliated user in the room or null if the user is not in the
	 *         room.
	 */
	...
	/**
	 * Returns the current nickname of the affiliated user if the user is currently in the room. If
	 * the user is not present in the room then the answer will be null.
