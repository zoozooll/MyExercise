...
/**
 * A listener that is fired anytime your participant's status in a room is changed, such as the user
...
public interface UserStatusListener {
	 ...
	 * moderated room before and now you can participate in the room by sending messages to all
	 * occupants.
	 */
	public abstract void voiceGranted();
	/**
	 * Called when a moderator revokes voice from your user. This means that you were a participant
	 * in the room able to speak and now you are a visitor that can't send messages to the room
	 * occupants.
	 */
	 ...
	 * will be able to kick users, grant and revoke voice, invite other users, modify room's subject
	 * plus all the partcipants privileges.
	 */
	public abstract void moderatorGranted();
	/**
	 * Called when an administrator revokes moderator privileges from your user. This means that you
	 * will no longer be able to kick users, grant and revoke voice, invite other users, modify
	 * room's subject plus all the partcipants privileges.
	 */
	public abstract void moderatorRevoked();
	/**
	 * Called when an owner grants to your user ownership on the room. This means that you will be
	 * able to change defining room features as well as perform all administrative functions.
	 */
	public abstract void ownershipGranted();
	/**
	 * Called when an owner revokes from your user ownership on the room. This means that you will
	...
	/**
	 * Called when an owner grants administrator privileges to your user. This means that you will
	 * be able to perform administrative functions such as banning users and edit moderator list.
	 */
