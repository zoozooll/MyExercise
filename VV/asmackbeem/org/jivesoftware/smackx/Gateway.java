...
/**
 * This class provides an abstract view to gateways/transports. This class handles all actions
 * regarding gateways and transports.
 * @author Till Klocke
 */
public class Gateway {
	...
	/**
	 * Returns the name as proposed in this gateways identity discovered via service discovery
	...
	/**
	 * Returns the type as proposed in this gateways identity discovered via service discovery. See
	 * {@link http ://xmpp.org/registrar/disco-categories.html} for possible types
	...
	/**
	 * Returns true if the registration informations indicates that you are already registered with
	 * this gateway
	...
	/**
	 * Returns the value of specific field of the registration information. Can be used to retrieve
	 * for example to retrieve username/password used on an already registered gateway.
	...
	/**
	 * Lets you login manually in this gateway. Normally a gateway logins you when it receives the
	 * first presence broadcasted by your server. But it is possible to manually login and logout by
	 * sending a directed presence. This method sends an empty available presence direct to the
	 * gateway.
	 */
	public void login() {
	...
	/**
	 * This method lets you send the presence direct to the gateway. Type, To and From are modified.
	...
	/**
	 * This method logs you out from this gateway by sending an unavailable presence to directly to
	 * this gateway.
	 */
	public void logout() {
