...
/**
 * The MUCUserProvider parses packets with extended presence information about roles and
 * affiliations.
 * @author Gaston Dombiak
 */
public class MUCUserProvider implements PacketExtensionProvider {
	/**
	 * Creates a new MUCUserProvider. ProviderManager requires that every PacketExtensionProvider
