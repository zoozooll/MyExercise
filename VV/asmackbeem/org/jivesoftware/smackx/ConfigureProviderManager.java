...
/**
 * Since dalvik on Android does not allow the loading of META-INF files from the filesystem, you
 * have to register every provider manually. The full list of providers is at:
 * http://fisheye.igniterealtime.org/browse/smack/trunk/build/resources
 * /META-INF/smack.providers?hb=true
