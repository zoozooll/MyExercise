...
public class MetaDataUtils {
	/**
	 * Parses any available meta-data and returns it as a Map of String name/value pairs. The parser
	 * must be positioned at an opening meta-data tag, or the an empty map will be returned.
