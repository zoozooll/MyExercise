...
public class AgentStatus implements PacketExtension {
	...
	/**
	 * Returns a collection of ChatInfo where each ChatInfo represents a Chat where this agent is
	 * participating.
	 * @return a collection of ChatInfo where each ChatInfo represents a Chat where this agent is
	 *         participating.
	 */
	...
	public static class ChatInfo {
		...
		/**
		 * Returns the user unique identification of the user that made the initial request and for
		 * which this chat was generated. If the user joined using an anonymous connection then the
		 * userID will be the value of the ID attribute of the USER element. Otherwise, the userID
