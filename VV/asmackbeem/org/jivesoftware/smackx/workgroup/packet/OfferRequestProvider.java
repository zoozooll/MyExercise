...
public class OfferRequestProvider implements IQProvider {
	...
	public static class OfferRequestPacket extends IQ {
		...
		/**
		 * Returns the userID, which is either the same as the userJID or a special value that the
		 * user provided as part of their "join queue" request.
		 * @return the user ID.
		 */
		...
		/**
		 * Returns the session ID associated with the request and ensuing chat. If the offer does
		 * not contain a session ID, <tt>null</tt> will be returned.
