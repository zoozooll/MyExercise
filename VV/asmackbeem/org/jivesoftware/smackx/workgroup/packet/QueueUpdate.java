...
/**
 * An IQ packet that encapsulates both types of workgroup queue status notifications -- position
 * updates, and estimated time left in the queue updates.
 */
public class QueueUpdate implements PacketExtension {
	...
	/**
	 * Returns the user's position in the workgroup queue, or -1 if the value isn't set on this
	 * packet.
	...
	/**
	 * Returns the user's estimated time left in the workgroup queue, or -1 if the value isn't set
	 * on this packet.
