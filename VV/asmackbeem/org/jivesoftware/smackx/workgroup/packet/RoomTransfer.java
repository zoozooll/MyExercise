...
public class RoomTransfer implements PacketExtension {
	...
	/**
	 * JID of the entity being invited. The entity could be another agent, user , a queue or a
	 * workgroup. In the case of a queue or a workgroup the server will select the best agent to
	 * invite.
	 */
