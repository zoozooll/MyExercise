...
/**
 * Agent status request packet. This packet is used by agents to request the list of agents in a
 * workgroup. The response packet contains a list of packets. Presence packets from individual
 * agents follow.
 * @author Matt Tucker
 */
