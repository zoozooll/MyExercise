...
/**
 * Represents the conversation transcript that occured in a group chat room between an Agent and a
 * user that requested assistance. The transcript contains all the Messages that were sent to the
 * room as well as the sent presences.
...
public class Transcript extends IQ {
	...
	/**
	 * Creates a new transcript for the given sessionID and list of packets. The list of packets may
	 * include Messages and/or Presences.
