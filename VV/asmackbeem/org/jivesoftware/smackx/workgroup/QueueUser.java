...
/**
 * An immutable class which wraps up customer-in-queue data return from the server; depending on the
 * type of information dispatched from the server, not all information will be available in any
 * given instance.
...
public class QueueUser {
	...
	/**
	 * @return the position in the queue at which the customer sits, or -1 if the update which this
	 *         instance embodies is only a time update instead
	 */
	public int getQueuePosition() {
		return this.queuePosition;
	}
	/**
	 * @return the estimated time remaining of the customer in the queue in seconds, or -1 if if the
	 *         update which this instance embodies is only a position update instead
	 */
