...
public class WorkgroupInvitation {
	 ...
	 * @param jid the jid string with which the issuing AgentSession or Workgroup instance was
	 *            created
	...
	/**
	 * @return the jid string with which the issuing AgentSession or Workgroup instance was created.
	 */
	public String getUniqueID() {
		return this.uniqueID;
	}
	/**
	 * @return the session id associated with the pending chat; working backwards temporally, this
	 *         session id should match the session id to the corresponding offer request which
	 *         resulted in this invitation.
	 */
