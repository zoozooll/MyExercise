...
/**
 * Type of content being included in the offer. The content actually explains the reason the agent
 * is getting an offer.
 * @author Gaston Dombiak
 */
public abstract class OfferContent {
	/**
	 * Returns true if the content of the offer is related to a user request. This is the most
	 * common type of offers an agent should receive.
	 ...
	 * @return true if the content of the offer is related to a room invitation made by another
	 *         agent.
	 */
	abstract boolean isInvitation();
	/**
	 * Returns true if the content of the offer is related to a service transfer made by another
	 * agent. This type of offers include the room to join, metadata sent by the user while joining
	 * the queue and the reason why the agent is receiving the transfer offer.
	 * @return true if the content of the offer is related to a service transfer made by another
	 *         agent.
	 */
