...
public interface OfferConfirmationListener {
	 ...
	 * the acceptance of the <code>Offer</code>. The instance will then have the ability to create
	 * the room and send the service the room name created for tracking.
