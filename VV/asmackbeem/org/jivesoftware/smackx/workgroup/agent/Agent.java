...
public class Agent {
	...
	/**
	 * Changes the name of the agent in the server. The server may have this functionality disabled
	 * for all the agents or for this agent in particular. If the agent is not allowed to change his
	 * name then an exception will be thrown with a service_unavailable error code.
