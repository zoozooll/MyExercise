...
public class Offer {
	 ...
	 * @param content content of the offer. The content explains the reason for the offer (e.g. user
	 *            request, transfer)
	 */
	 ...
	 * the JID of the requesting user. However, users can also manually specify a userID for their
	 * request. In that case, that value will be returned.
	...
	/**
	 * The date when the offer will expire. The agent must {@link #accept()} the offer before the
	 * expiration date or the offer will lapse and be routed to another agent. Alternatively, the
	 * agent can {@link #reject()} the offer at any time if they don't wish to accept it..
	...
	/**
	 * Returns the content of the offer. The content explains the reason for the offer (e.g. user
	 * request, transfer)
