...
/**
 * Represents a form that could be use for gathering data as well as for reporting data returned
 * from a search.
...
public class DataForm implements PacketExtension {
	 ...
	 * <ul>
	 * <li>form -> This packet contains a form to fill out. Display it to the user (if your program
	 * can).</li>
	 ...
	 * instruction could not contain newlines characters. Join the instructions together in order to
	...
	/**
	 * Adds a new instruction to the list of instructions that explain how to fill out the form and
	 * what the form is about. The dataform could include multiple instructions since each
