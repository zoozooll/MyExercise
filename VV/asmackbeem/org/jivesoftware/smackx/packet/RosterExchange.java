 ...
 * adding to the &lt;message/&gt; element an &lt;x/&gt; child scoped by the 'jabber:x:roster'
 * namespace. This &lt;x/&gt; element may contain one or more &lt;item/&gt; children (one for each
...
public class RosterExchange implements PacketExtension {
	 ...
	 * specification the namespace is always "jabber:x:roster" (which is not to be confused with the
	...
	/**
	 * Returns the XML representation of a Roster Item Exchange according the specification. Usually
	 * the XML representation will be inside of a Message XML representation like in the following
	 * example:
	 * 
	 * <pre>
