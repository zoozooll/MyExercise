...
/**
 * IQ packet that serves for kicking users, granting and revoking voice, banning users, modifying
 * the ban list, granting and revoking membership and granting and revoking moderator privileges.
 * All these operations are scoped by the 'http://jabber.org/protocol/muc#admin' namespace.
...
public class MUCAdmin extends IQ {
	...
	/**
	 * Returns an Iterator for item childs that holds information about roles, affiliation, jids and
	 * nicks.
	 * @return an Iterator for item childs that holds information about roles, affiliation, jids and
	 *         nicks.
	 */
