...
/**
 * A last activity IQ for retrieving information about the last activity associated with a Jabber
 * ID. LastActivity (JEP-012) allows for retrieval of how long a particular user has been idle and
 * the message the specified when doing so. Use {@link org.jivesoftware.smackx.LastActivityManager}
...
public class LastActivity extends IQ {
	...
	/**
	 * Returns number of seconds that have passed since the user last logged out. If the user is
	 * offline, 0 will be returned.
