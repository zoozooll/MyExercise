...
public class StreamInitiation extends IQ {
	...
	/**
	 * The "id" attribute is an opaque identifier. This attribute MUST be present on type='set', and
	 * MUST be a valid string. This SHOULD NOT be sent back on type='result', since the <iq/> "id"
	 * attribute provides the only context needed. This value is generated by the Sender, and the
	 * same value MUST be used throughout a session when talking to the Receiver.
	...
	/**
	 * The "mime-type" attribute identifies the MIME-type for the data across the stream. This
	 * attribute MUST be a valid MIME-type as registered with the Internet Assigned Numbers
	 * Authority (IANA) [3] (specifically, as listed at
	 * <http://www.iana.org/assignments/media-types>). During negotiation, this attribute SHOULD be
	 * present, and is otherwise not required. If not included during negotiation, its value is
	 * assumed to be "binary/octect-stream".
	 ...
	 * @return Returns the data form which contains the valid methods of stream neotiation and
	 *         transfer.
	 */
	...
	public static class File implements PacketExtension {
		 ...
		 * @param desc The description of the file so that the file reciever can know what file it
		 *            is.
		 */
		 ...
		 * @return Returns whether or not the initiator can support a range for the file tranfer.
		 */
