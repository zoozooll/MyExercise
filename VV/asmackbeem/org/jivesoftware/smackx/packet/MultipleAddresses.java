...
public class MultipleAddresses implements PacketExtension {
	 ...
	 * @param node used to specify a sub-addressable unit at a particular JID, corresponding to a
	...
	/**
	 * Returns the list of addresses that matches the specified type. Examples of address type are:
	 * TO, CC, BCC, etc..
