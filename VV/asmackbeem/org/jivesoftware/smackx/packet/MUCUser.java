...
/**
 * Represents extended presence information about roles, affiliations, full JIDs, or status codes
 * scoped by the 'http://jabber.org/protocol/muc#user' namespace.
...
public class MUCUser implements PacketExtension {
	...
	/**
	 * Returns the invitation for another user to a room. The sender of the invitation must be an
	 * occupant of the room. The invitation will be sent to the room which in turn will forward the
	...
	/**
	 * Returns the password to use to enter Password-Protected Room. A Password-Protected Room is a
	 * room that a user cannot enter without first providing the correct password.
	...
	/**
	 * Sets the invitation for another user to a room. The sender of the invitation must be an
	 * occupant of the room. The invitation will be sent to the room which in turn will forward the
	 * invitation to the invitee.
	...
	/**
	 * Sets the rejection to an invitation from another user to a room. The rejection will be sent
	 * to the room which in turn will forward the refusal to the inviter.
	...
	/**
	 * Sets the password to use to enter Password-Protected Room. A Password-Protected Room is a
	 * room that a user cannot enter without first providing the correct password.
	 ...
	 * @param status the status which holds a code that assists in presenting notification messages.
	 */
	public void setStatus(Status status) {
		this.status = status;
	}
	/**
	 * Sets the notification that the room has been destroyed. After a room has been destroyed, the
	 * room occupants will receive a Presence packet of type 'unavailable' with the reason for the
	 * room destruction if provided by the room owner.
	...
	/**
	 * Represents an invitation for another user to a room. The sender of the invitation must be an
	 * occupant of the room. The invitation will be sent to the room which in turn will forward the
	 * invitation to the invitee.
	 * @author Gaston Dombiak
	 */
	...
	public static class Item {
		...
		/**
		 * Returns the <room@service/nick> by which an occupant is identified within the context of
		 * a room. If the room is non-anonymous, the JID will be included in the item.
		 ...
		 * possible roles are "moderator", "participant", and "visitor" (it is also possible to have
		 * no defined role). A role lasts only for the duration of an occupant's visit to a room.
		...
		/**
		 * Sets the reason for the item child. The reason is optional and could be used to explain
		...
		/**
		 * Sets the <room@service/nick> by which an occupant is identified within the context of a
		...
		/**
		 * Sets the new nickname of an occupant that is changing his/her nickname. The new nickname
	...
	/**
	 * Status code assists in presenting notification messages. The following link provides the list
	 * of existing error codes (@link http://www.jabber.org/jeps/jep-0045.html#errorstatus).
	 * @author Gaston Dombiak
	 */
	public static class Status {
		...
		/**
		 * Returns the code that uniquely identifies the reason of the error. The code assists in
