 ...
 * <p>
 * The received information may contain one or more identities of the requested XMPP entity, and a
 * list of supported features by the requested XMPP entity.
...
public class DiscoverInfo extends IQ {
	...
	/**
	 * Returns the node attribute that supplements the 'jid' attribute. A node is merely something
	 * that is associated with a JID and for which the JID can provide information.
	 * <p>
	 * Node attributes SHOULD be used only when trying to provide or query information which is not
	...
	/**
	 * Sets the node attribute that supplements the 'jid' attribute. A node is merely something that
	 * is associated with a JID and for which the JID can provide information.
	 * <p>
	 * Node attributes SHOULD be used only when trying to provide or query information which is not
	 * directly addressable.
	...
	@Override
	public DiscoverInfo clone() throws CloneNotSupportedException {
	 ...
	 * <p>
	 * Refer to <a href="http://www.jabber.org/registrar/disco-categories.html">Jabber
	 * ::Registrar</a> in order to get the official registry of values for the <i>category</i> and
	 * <i>type</i> attributes.
	 */
	public static class Identity {
		...
		/**
		 * Returns the entity's category. To get the official registry of values for the 'category'
		 * attribute refer to <a href="http://www.jabber.org/registrar/disco-categories.html"
		 * >Jabber::Registrar</a>
		...
		/**
		 * Returns the entity's type. To get the official registry of values for the 'type'
		 * attribute refer to <a href="http://www.jabber.org/registrar/disco-categories.html"
		 * >Jabber::Registrar</a>
		...
		/**
		 * Sets the entity's type. To get the official registry of values for the 'type' attribute
		 * refer to <a href="http://www.jabber.org/registrar/disco-categories.html"
		 * >Jabber::Registrar</a>
	...
	/**
	 * Represents the features offered by the item. This information helps requestors determine what
	 * actions are possible with regard to this item (registration, search, join, etc.) as well as
	 * specific feature types of interest, if any (e.g., for the purpose of feature negotiation).
	 */
