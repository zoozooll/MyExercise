 ...
 * <p>
 * The 'http://jabber.org/protocol/pubsub#event' namespace is used to publish personal events items
 * from one client to subscribed clients (See XEP-163).
...
public class PEPEvent implements PacketExtension {
	 ...
	 * Usually the XML representation will be inside of a Message XML representation like in the
	 * following example:
	 * 
	 * <pre>
