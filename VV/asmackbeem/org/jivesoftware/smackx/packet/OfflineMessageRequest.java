...
/**
 * Represents a request to get some or all the offline messages of a user. This class can also be
 * used for deleting some or all the offline messages of a user.
...
public class OfflineMessageRequest extends IQ {
	...
	/**
	 * Returns an Iterator for item childs that holds information about offline messages to view or
	 * delete.
	 * @return an Iterator for item childs that holds information about offline messages to view or
	 *         delete.
	 */
