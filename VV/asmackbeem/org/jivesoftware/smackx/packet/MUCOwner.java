...
/**
 * IQ packet that serves for granting and revoking ownership privileges, granting and revoking
 * administrative privileges and destroying a room. All these operations are scoped by the
...
public class MUCOwner extends IQ {
	 ...
	 * @return an Iterator for item childs that holds information about affiliation, jids and nicks.
	 */
	...
	/**
	 * Returns a request to the server to destroy a room. The sender of the request should be the
	 * room's owner. If the sender of the destroy request is not the room's owner then the server
	 * will answer a "Forbidden" error.
	...
	/**
	 * Sets a request to the server to destroy a room. The sender of the request should be the
	 * room's owner. If the sender of the destroy request is not the room's owner then the server
	 * will answer a "Forbidden" error.
	...
	public static class Item {
		 ...
		 * roles are "moderator", "participant", and "visitor" (it is also possible to have no
		 * defined role). A role lasts only for the duration of an occupant's visit to a room.
