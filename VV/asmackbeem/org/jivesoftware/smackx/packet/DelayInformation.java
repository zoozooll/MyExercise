 ...
 * for the delay.
 * <p>
 * For more information see <a href="http://xmpp.org/extensions/xep-0091.html">XEP-0091</a> and <a
 * href="http://xmpp.org/extensions/xep-0203.html">XEP-0203</a>.
 * @author Gaston Dombiak
 */
public class DelayInformation implements PacketExtension {
	/**
	 * Date format according to the obsolete XEP-0091 specification. XEP-0091 recommends to use this
	 * old format for date-time instead of the one specified in XEP-0082.
	 * <p>
	...
	/**
	 * Returns the JID of the entity that originally sent the packet or that delayed the delivery of
	 * the packet or <tt>null</tt> if this information is not available.
	 * @return the JID of the entity that originally sent the packet or that delayed the delivery of
	 *         the packet.
	 */
	...
	/**
	 * Sets the JID of the entity that originally sent the packet or that delayed the delivery of
	 * the packet or <tt>null</tt> if this information is not available.
	...
	/**
	 * Returns the timestamp when the packet was originally sent. The returned Date is be understood
	 * as UTC.
	...
	/**
	 * Returns a natural-language description of the reason for the delay or <tt>null</tt> if this
	...
	/**
	 * Sets a natural-language description of the reason for the delay or <tt>null</tt> if this
	 * information is not available.
