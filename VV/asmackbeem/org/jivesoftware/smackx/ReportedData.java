...
/**
 * Represents a set of data results returned as part of a search. The report is structured in
 * columns and rows.
...
public class ReportedData {
	...
	/**
	 * Returns a new ReportedData if the packet is used for reporting data and includes an extension
	...
	/**
	 * Creates a new ReportedData based on the returned dataForm from a search (namespace
	 * "jabber:iq:search").
	...
	public static class Column {
		 ...
		 * <li>fixed -> fixed for putting in text to show sections, or just advertise your web site
		 * in the middle of the form
		 * <li>hidden -> is not given to the user at all, but returned with the questionnaire
		 * <li>jid-single -> Jabber ID - choosing a JID from your roster, and entering one based on
		 * the rules for a JID.
