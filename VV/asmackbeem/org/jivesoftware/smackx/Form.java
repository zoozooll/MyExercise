 ...
 * <li>submit -> The form is filled out, and this is the data that is being returned from the form.</li>
...
public class Form {
	...
	/**
	 * Creates a new Form that will wrap an existing DataForm. The wrapped DataForm must be used for
	 * gathering data.
	 ...
	 * requested variable will be completed with the specified value. If no field could be found for
	 ...
	 * @throws IllegalArgumentException if the form does not include the specified variable or if
	 *             the answer type does not correspond with the field type..
	 */
	...
	/**
	 * Sets a new int value to a given form's field. The field whose variable matches the requested
	...
	/**
	 * Sets a new long value to a given form's field. The field whose variable matches the requested
	 * variable will be completed with the specified value. If no field could be found for the
	 * specified variable then an exception will be raised.
	 * @param variable the variable name that was completed.
	...
	/**
	 * Sets a new Object value to a given form's field. In fact, the object representation (i.e.
	 * #toString) will be the actual value of the field.
	 * <p>
	 * If the value to set to the field is not a basic type (e.g. String, boolean, int, etc.) you
	 * will need to use {@link #setAnswer(String, String))} where the String value is the String
	 * representation of the object.
	 * <p>
	 * Before setting the new value to the field we will check if the form is of type submit. If the
	 * form isn't of type submit means that it's not possible to complete the form and an exception
	 * will be thrown.
	 * @param field the form field that was completed.
	 * @param value the Object value that was answered. The object representation will be the actual
	 *            value.
	 * @throws IllegalStateException if the form is not of type "submit".
	 */
	...
	/**
	 * Returns the field of the form whose variable matches the specified variable. The fields of
	 * type FIXED will never be returned since they do not specify a variable.
	 ...
	 * of the original form except for the fields of type FIXED. Only the HIDDEN fields will include
	 * the same value of the original form. The other fields of the new form MUST be completed. If a
	 * field remains with no answer when sending the completed form, then it won't be included as
	 * part of the completed form.
	 * <p>
	 * The reason why the fields with variables are included in the new form is to provide a model
	 * for binding with any UI. This means that the UIs will use the original form (of type "form")
	 * to learn how to render the form, but the UIs will bind the fields to the form of type submit.
