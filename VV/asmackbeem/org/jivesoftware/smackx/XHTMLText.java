...
public class XHTMLText {
	...
	/**
	 * Appends a tag that creates an ordered list. "Ordered" means that the order of the items in
	 * the list is important. To show this, browsers automatically number the list.
	...
	/**
	 * Appends a tag that creates an unordered list. The unordered part means that the items in the
	 * list are not in any particular order.
	...
	/**
	 * Appends a tag that indicates the start of a new paragraph. This is usually rendered with two
	 * carriage returns, producing a single blank line in between the two paragraphs.
	...
	/**
	 * Appends a tag that indicates the end of a new paragraph. This is usually rendered with two
	 * carriage returns, producing a single blank line in between the two paragraphs.
	 */
