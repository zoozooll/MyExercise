...
public abstract class FileTransfer {
	 ...
	 * @return Returns the progress of the file transfer as a number between 0 and 1.
	 */
	...
	/**
	 * Returns true if the transfer has been cancelled, if it has stopped because of a an error, or
	 * the transfer completed successfully.
	 * @return Returns true if the transfer has been cancelled, if it has stopped because of a an
	 *         error, or the transfer completed successfully.
	 */
	...
	/**
	 * When {@link #getStatus()} returns that there was an {@link Status#error} during the transfer,
	 * the type of error can be retrieved through this method.
	...
	/**
	 * If an exception occurs asynchronously it will be stored for later retrieval. If there is an
	 * error there maybe an exception set.
	...
	public enum Status {
		...
		initial("Initial"),
		/**
		 * The file transfer is being negotiated with the peer. The party Receiving the file has the
		 * option to accept or refuse a file transfer request. If they accept, then the process of
		 * stream negotiation will begin. If they refuse the file will not be transfered.
		 * @see #negotiating_stream
		 */
		negotiating_transfer("Negotiating Transfer"),
		/**
		 * The peer has refused the file transfer request halting the file transfer negotiation
		 * process.
		 */
		refused("Refused"),
		/**
		 * The stream to transfer the file is being negotiated over the chosen stream type. After
		 * the stream negotiating process is complete the status becomes negotiated.
		 * @see #negotiated
		 */
		negotiating_stream("Negotiating Stream"),
		/**
		 * After the stream negotiation has completed the intermediate state between the time when
		 * the negotiation is finished and the actual transfer begins.
		 */
