...
public class FileTransferRequest {
	...
	/**
	 * A recieve request is constructed from the Stream Initiation request received from the
	 * initator.
	 ...
	 * @return Returns the fully-qualified jabber ID of the user that requested this file transfer.
	 */
	 ...
	 * @return Returns the stream ID that uniquely identifies this file transfer.
	 */
	public String getStreamID() {
		return streamInitiation.getSessionID();
	}
	/**
	 * Returns the stream initiation packet that was sent by the requestor which contains the
	 * parameters of the file transfer being transfer and also the methods available to transfer the
	 * file.
	 * @return Returns the stream initiation packet that was sent by the requestor which contains
	 *         the parameters of the file transfer being transfer and also the methods available to
	 *         transfer the file.
	 */
	 ...
	 * @return Returns the <b><i>IncomingFileTransfer</b></i> on which the file transfer can be
	 *         carried out.
	 */
