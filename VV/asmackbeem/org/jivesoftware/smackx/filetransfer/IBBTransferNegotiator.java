...
/**
 * The In-Band Bytestream file transfer method, or IBB for short, transfers the file over the same
 * XML Stream used by XMPP. It is the fall-back mechanism in case the SOCKS5 bytestream method of
 * transferring files is not available.
 * @author Alexander Wenckus
 * @author Henning Staib
 * @see <a href="http://xmpp.org/extensions/xep-0047.html">XEP-0047: In-Band Bytestreams (IBB)</a>
 */
public class IBBTransferNegotiator extends StreamNegotiator {
	...
	public PacketFilter getInitiationPacketFilter(String from, String streamID) {
		/*
		 * this method is always called prior to #negotiateIncomingStream() so the In-Band
		 * Bytestream initiation listener must ignore the next In-Band Bytestream request with the
		 * given session ID
		 */
	...
	/**
	 * This PacketFilter accepts an incoming In-Band Bytestream open request with a specified
	 * session ID.
	 */
