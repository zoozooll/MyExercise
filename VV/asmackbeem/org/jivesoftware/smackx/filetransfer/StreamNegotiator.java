...
/**
 * After the file transfer negotiation process is completed according to JEP-0096, the negotiation
 * process is passed off to a particular stream negotiator. The stream negotiator will then
 * negotiate the chosen stream and return the stream to transfer the file.
...
public abstract class StreamNegotiator {
	...
	/**
	 * This method handles the file stream download negotiation process. The appropriate stream
	 * negotiator's initiate incoming stream is called after an appropriate file transfer method is
	 * selected. The manager will respond to the initiator with the selected means of transfer, then
	 * it will handle any negotiation specific to the particular transfer method. This method
	 * returns the InputStream, ready to transfer the file.
	 * @param initiation The initiation that triggered this download.
	 * @return After the negotiation process is complete, the InputStream to write a file to is
	 *         returned.
	 * @throws XMPPException If an error occurs during this process an XMPPException is thrown.
	 * @throws InterruptedException If thread is interrupted.
	 */
	public abstract InputStream createIncomingStream(StreamInitiation initiation)
			throws XMPPException, InterruptedException;
	/**
	 * This method handles the file upload stream negotiation process. The particular stream
	 * negotiator is determined during the file transfer negotiation process. This method returns
	 * the OutputStream to transmit the file to the remote user.
	 ...
	 * @param target The fully-qualified JID of the target or receiver of the file transfer.
	 * @return The negotiated stream ready for data.
	 * @throws XMPPException If an error occurs during the negotiation process an exception will be
	 *             thrown.
	 */
	 ...
	 * @return Returns the XMPP namespace reserved for this particular type of file transfer.
	 */
