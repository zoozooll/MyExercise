...
/**
 * Handles the sending of a file to another user. File transfer's in jabber have several steps and
 * there are several methods in this class that handle these steps differently.
...
public class OutgoingFileTransfer extends FileTransfer {
	...
	/**
	 * Returns the time in milliseconds after which the file transfer negotiation process will
	 * timeout if the other user has not responded.
	 * @return Returns the time in milliseconds after which the file transfer negotiation process
	 *         will timeout if the remote user has not responded.
	 */
	public static int getResponseTimeout() {
		return RESPONSE_TIMEOUT;
	}
	/**
	 * Sets the time in milliseconds after which the file transfer negotiation process will timeout
	 * if the other user has not responded.
	...
	/**
	 * Returns the output stream connected to the peer to transfer the file. It is only available
	 * after it has been successfully negotiated by the {@link StreamNegotiator}.
	...
	/**
	 * This method handles the negotiation of the file transfer and the stream, it only returns the
	 * created stream after the negotiation has been completed.
	 * @param fileName The name of the file that will be transmitted. It is preferable for this name
	 *            to have an extension as it will be used to determine the type of file it is.
	 ...
	 * @return The OutputStream that is connected to the peer to transmit the file.
	 * @throws XMPPException Thrown if an error occurs during the file transfer negotiation process.
	 */
	...
	/**
	 * This methods handles the transfer and stream negotiation process. It returns immediately and
	 * its progress will be updated through the {@link NegotiationProgress} callback.
	 * @param fileName The name of the file that will be transmitted. It is preferable for this name
	 *            to have an extension as it will be used to determine the type of file it is.
	 * @param fileSize The size in bytes of the file that will be transmitted.
	 * @param description A description of the file that will be transmitted.
	 * @param progress A callback to monitor the progress of the file transfer negotiation process
	 *            and to retrieve the OutputStream when it is complete.
	 */
	 ...
	 * It returns immediately and the progress of the file transfer can be monitored through several
	 * methods:
	 * <UL>
	 ...
	 * @throws XMPPException If there is an error during the negotiation process or the sending of
	 *             the file.
	 */
	...
	/**
	 * Returns the amount of bytes that have been sent for the file transfer. Or -1 if the file
	 * transfer has not started.
	 * <p>
	 * Note: This method is only useful when the {@link #sendFile(File, String)} method is called,
	 * as it is the only method that actually transmits the file.
	 * @return Returns the amount of bytes that have been sent for the file transfer. Or -1 if the
