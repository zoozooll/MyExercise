...
/**
 * The file transfer manager class handles the sending and recieving of files. To send a file invoke
 * the {@link #createOutgoingFileTransfer(String)} method.
 * <p>
 * And to recieve a file add a file transfer listener to the manager. The listener will notify you
 * when there is a new file transfer request. To create the {@link IncomingFileTransfer} object
 * accept the transfer, or, if the transfer is not desirable reject it.
...
public class FileTransferManager {
	 ...
	 * @param userID The fully qualified jabber ID with resource of the user to send the file to.
	 ...
	 * an IncomingFileTransfer which allows the transmission of the file to procede.
	 * @param request The remote request that is being accepted.
	 * @return The IncomingFileTransfer which manages the download of the file from the transfer
	 *         initiator.
	 */
