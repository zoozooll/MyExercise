...
/**
 * A last activity manager for handling information about the last activity associated with a Jabber
 * ID. A manager handles incoming LastActivity requests of existing Connections. It also allows to
 * request last activity information of other users.
 * <p>
 ...
 * </ol>
 * <p/>
 * For example to get the idle time of a user logged in a resource, simple send the LastActivity
 * packet to them, as in the following code:
 * <p>
 * 
 * <pre>
 ...
 * </pre>
 * 
 * To get the uptime of a host, you simple send the LastActivity packet to it, as in the following
 * code example:
 * <p>
 * 
 * <pre>
...
public class LastActivityManager {
	...
	/**
	 * Resets the idle time to 0, this should be invoked when a new message is sent.
	 */
