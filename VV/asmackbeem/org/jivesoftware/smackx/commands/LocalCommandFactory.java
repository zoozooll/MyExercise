...
/**
 * A factory for creating local commands. It's useful in cases where instantiation of a command is
 * more complicated than just using the default constructor. For example, when arguments must be
 * passed into the constructor or when using a dependency injection framework. When a
 * LocalCommandFactory isn't used, you can provide the AdHocCommandManager a Class object instead.
