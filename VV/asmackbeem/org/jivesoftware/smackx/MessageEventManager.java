...
/**
 * Manages message events requests and notifications. A MessageEventManager provides a high level
 * access to request for notifications and send event notifications. It also provides an easy way to
 * hook up custom logic when requests or notifications are received.
...
public class MessageEventManager {
	...
	/**
	 * Adds event notification requests to a message. For each event type that the user wishes event
	 * notifications from the message recepient for, <tt>true</tt> should be passed in to this
	 * method.
	...
	/**
	 * Adds a message event request listener. The listener will be fired anytime a request for event
	...
	/**
	 * Removes a message event notification listener. The listener will be fired anytime a
