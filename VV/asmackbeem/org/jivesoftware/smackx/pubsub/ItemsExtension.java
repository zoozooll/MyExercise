...
/**
 * This class is used to for multiple purposes. <li>It can represent an event containing a list of
 * items that have been published <li>It can represent an event containing a list of retracted
 * (deleted) items. <li>It can represent a request to delete a list of items. <li>It can represent a
 * request to get existing items.
 * <p>
 * <b>Please note, this class is used for internal purposes, and is not required for usage of pubsub
 * functionality.</b>
...
public class ItemsExtension extends NodeExtension implements
	...
	public enum ItemsElementType {
		...
		/**
		 * A retract element, which has an optional <b>notify</b> attribute when publishing
		 * deletions
		 */
	 ...
	 * <li>Items published event - itemsType = {@link ItemsElementType#items}, items = list of
	 * {@link Item} and attributeValue = <code>null</code>
	 * <li>Items deleted event - itemsType = {@link ItemsElementType#items}, items = list of
	 * {@link RetractItem} and attributeValue = <code>null</code>
	...
	/**
	 * Gets the items related to the type of request or event. return List of {@link Item},
	 * {@link RetractItem}, or null
	 */
