...
/**
 * Generic packet extension which represents any pubsub form that is parsed from the incoming stream
 * or being sent out to the server. Form types are defined in {@link FormNodeType}.
...
public class FormNode extends NodeExtension {
	...
	/**
	 * Create a {@link FormNode} which contains the specified form, which is associated with the
	 * specified node.
	 * @param formType The type of form being sent
