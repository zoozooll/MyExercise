...
public class ItemDeleteEvent extends SubscriptionEvent {
	...
	/**
	 * Constructs an <tt>ItemDeleteEvent</tt> that indicates the the supplied items (by id) have
	 * been deleted, and that the event matches the listed subscriptions. The subscriptions would
	 * have been created by calling {@link LeafNode#subscribe(String)}.
