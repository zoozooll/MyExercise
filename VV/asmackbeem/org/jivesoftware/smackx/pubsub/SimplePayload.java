...
/**
 * The default payload representation for {@link Item#getPayload()}. It simply stores the XML
 * payload as a string.
...
public class SimplePayload implements PacketExtension {
	...
	/**
	 * Construct a <tt>SimplePayload</tt> object with the specified element name, namespace and
	 * content. The content must be well formed XML.
