...
/**
 * Represents a affiliation between a user and a node, where the {@link #type} defines the type of
 * affiliation. Affiliations are retrieved from the {@link PubSubManager#getAffiliations()} method,
 * which gets affiliations for the calling user, based on the identity that is associated with the
 * {@link Connection}.
