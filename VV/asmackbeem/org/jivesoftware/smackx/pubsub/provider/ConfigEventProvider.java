...
/**
 * Parses the node configuration element out of the message event stanza from the server as
 * specified in the <a href="http://xmpp.org/extensions/xep-0060.html#schemas-event">configuration
 * schema</a>.
