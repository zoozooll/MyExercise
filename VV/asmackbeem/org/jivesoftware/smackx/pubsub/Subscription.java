...
public class Subscription extends NodeExtension {
	...
	/**
	 * Constructs a representation of a subscription reply to the specified node and JID. The server
	 * will have supplied the subscription id and current state.
	...
	/**
	 * Constructs a representation of a subscription reply to the specified node and JID. The server
	 * will have supplied the subscription id and current state and whether the subscription need to
	 * be configured.
	 * @param jid The JID the request was made under
	 * @param nodeId The node subscribed to
	 * @param subscriptionId The id of this subscription
