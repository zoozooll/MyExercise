...
abstract public class SubscriptionEvent extends NodeEvent {
	...
	/**
	 * Construct an event with no subscription id's. This can occur when there is only one
	 * subscription to a node. The event may or may not report the subscription id along with the
	 * event.
