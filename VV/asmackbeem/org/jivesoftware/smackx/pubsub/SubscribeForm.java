...
/**
 * A decorator for a {@link Form} to easily enable reading and updating of subscription options. All
 ...
 * exist, all <b>SubscribeForm.setXXX</b> methods will create the field in the wrapped form if it
...
public class SubscribeForm extends Form {
	...
	/**
	 * Determines whether the entity wants to receive an XMPP message body in addition to the
	 * payload format.
	...
	/**
	 * Sets whether the entity wants to receive an XMPP message body in addition to the payload
	 * format.
	...
	/**
	 * Gets the {@link PresenceState} for which an entity wants to receive notifications.
	...
	/**
	 * Sets the list of {@link PresenceState} for which an entity wants to receive notifications.
