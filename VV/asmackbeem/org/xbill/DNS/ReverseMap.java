...
public final class ReverseMap {
	...
	/**
	 * Creates a reverse map name corresponding to an address contained in an array of 4 bytes (for
	 * an IPv4 address) or 16 bytes (for an IPv6 address).
	 ...
	 * between 0 and 255 (for an IPv4 address) or 16 integers between 0 and 255 (for an IPv6
	 * address).
	 * @param addr The address from which to build a name.
	 * @return The name corresponding to the address in the reverse map.
	 */
