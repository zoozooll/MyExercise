...
public class Message implements Cloneable {
	...
	/**
	 * Creates a new Message to contain a dynamic update. A random Message ID and the zone are
	 * filled in.
	...
	/**
	 * Returns an array containing all records in the given section, or an empty array if the
	 * section is empty.
	 * @see Record
	 * @see Section
	 */
	 ...
	 * maximum length. This will generate a truncated message (with the TC bit) if the message
	 * doesn't fit, and will also sign the message with the TSIG key set by a call to setTSIG().
	 * This method may return null if the message could not be rendered at all; this could happen if
	 * maxLength is smaller than a DNS header, for example.
