...
public class SIG0 {
	 ...
	 * @param message The message to be signed
	 * @param b An array containing the message in unparsed form. This is necessary since SIG(0)
	 *            signs the message in wire format, and we can't recreate the exact wire format
	 *            (with the same name compression).
