...
public abstract class Record implements Cloneable, Comparable, Serializable {
	 ...
	 * lowercase), optionally ignoring the TTL.
	 */
	...
	/**
	 * Returns the type of RRset that this record would belong to. For all types except RRSIG, this
	 * is equivalent to getType().
	 ...
	 * This is most useful for dynamic update.
	 */
	 ...
	 * @return The value 0 if the argument is a record equivalent to this record; a value less than
	 *         0 if the argument is less than this record in the canonical ordering, and a value
	 *         greater than 0 if the argument is greater than this record in the canonical ordering.
	 *         The canonical ordering is defined to compare by name, class, type, and rdata.
	...
	/**
	 * Returns the name for which additional data processing should be done for this record. This
	 * can be used both for building responses and parsing responses.
