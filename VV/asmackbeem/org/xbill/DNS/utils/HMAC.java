...
public class HMAC {
	 ...
	 * @param digest The message digest object.
	 * @param key The secret key
	 * @deprecated won't work with digests using a padding length other than 64; use
	 *             {@code HMAC(MessageDigest digest, int blockLength,
	 *             byte [] key)} instead.
	 ...
	 * @param key The secret key.
	 * @deprecated won't work with digests using a padding length other than 64; use
	 *             {@code HMAC(String digestName, int blockLength, byte [] key)} instead
