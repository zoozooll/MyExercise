...
class Mnemonic {
	 ...
	 * @param wordcase Whether to convert strings into uppercase, lowercase, or leave them
	 *            unchanged. throwing exceptions.
	 */
	...
	/**
	 * Defines an additional text representation of a numeric value. This will be used by
	 * getValue(), but not getText().
	 * @param val The numeric value
	 * @param string The text string
	 */
