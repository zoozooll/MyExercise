 ...
 * other than those specified in the header. An OPT should be generated by Resolver. EDNS is a
 * method to extend the DNS protocol while providing backwards compatibility and not significantly
 * changing the protocol. This implementation of EDNS is mostly complete at level 0.
 * @see Message
 * @see Resolver
...
public class OPTRecord extends Record {
	 ...
	 *            dnsjava.
	 * @param options The list of options that comprise the data field. There are currently no
	 *            defined options.
	 * @see ExtendedFlags
	 */
	...
	/**
	 * Creates an OPT Record with no data. This is normally called by SimpleResolver, but can also
	 * be called by a server.
	 * @param payloadSize The size of a packet that can be reassembled on the sending host.
	 * @param xrcode The value of the extended rcode field. This is the upper 16 bits of the full
	 *            rcode.
	 * @param flags Additional message flags.
