...
public final class TTL {
	...
	/**
	 * Parses a TTL-like value, which can either be expressed as a number or a BIND-style string
	 ...
	 *            should be donw for TTLs, but not other values which can be expressed in this
	 *            format.
	...
	/**
	 * Parses a TTL, which can either be expressed as a number or a BIND-style string with numbers
	 * and units.
