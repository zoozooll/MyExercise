...
public class Name implements Comparable, Serializable {
	...
	private byte[] name;
	/*
	 * Effectively an 8 byte array, where the low order byte stores the number of labels and the 7
	 * higher order bytes store per-label offsets.
	 */
	...
	/**
	 * Create a new name from a string. This does not automatically make the name absolute; it will
	 * be absolute if it has a trailing dot.
	 * @param s The string to be converted
	 * @throws TextParseException The name is invalid.
	 */
	 ...
	 * Create a new name from a string and an origin. This does not automatically make the name
	 * absolute; it will be absolute if it has a trailing dot or an absolute origin is appended.
	 * This is identical to the constructor, except that it will avoid creating new objects in some
	 * cases.
	 * @param s The string to be converted
	 * @param origin If the name is not absolute, the origin to be appended.
	 * @throws TextParseException The name is invalid.
	...
	/**
	 * Create a new name from a string. This does not automatically make the name absolute; it will
	 * be absolute if it has a trailing dot. This is identical to the constructor, except that it
	 * will avoid creating new objects in some cases.
	 * @param s The string to be converted
	 * @throws TextParseException The name is invalid.
	 */
	...
	/**
	 * Create a new name from a constant string. This should only be used when the name is known to
	 * be good - that is, when it is constant.
	 * @param s The string to be converted
	 ...
	 * @param in A stream containing the DNS message which is currently positioned at the start of
	 *            the name to be read.
	 */
	...
	/**
	 * Retrieve the nth label of a Name. This makes a copy of the label; changing this does not
	 * change the Name.
	 ...
	 *         the argument is less than this name in the canonical ordering, and a value greater
	 *         than 0 if the argument is greater than this name in the canonical ordering.
