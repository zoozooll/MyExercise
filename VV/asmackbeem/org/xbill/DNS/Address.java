...
public final class Address {
	...
	/**
	 * Converts an address from its string representation to an IP address. The address can be
	 * either IPv4 or IPv6.
	 ...
	 * @return The IP addresses
	 * @exception UnknownHostException The address is not a valid IP address in the specified
	 *                address family.
	 */
