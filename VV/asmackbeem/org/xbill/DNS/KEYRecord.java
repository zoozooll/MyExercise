...
public class KEYRecord extends KEYBase {
	...
	public static class Protocol {
		...
		/**
		 * Converts a textual representation of a KEY protocol into its numeric code. Integers in
	...
	public static class Flags {
		...
		/**
		 * Converts a textual representation of KEY flags into its numeric code. Integers in the
