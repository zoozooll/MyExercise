...
public class Update extends Message {
	...
	/**
	 * Parses a record from the string, and inserts a prerequisite that the record exists. Due to
	 * the way value-dependent prequisites work, the condition that must be met is that the set of
	 * all records with the same and type in the update message must be identical to the set of all
	...
	/**
	 * Parses a record from the string, and indicates that the record should be deleted from the
	 * zone.
	 * @throws IOException The record could not be parsed.
	 */
	...
	/**
	 * Indicates that the record should be inserted into the zone replacing any other records with
